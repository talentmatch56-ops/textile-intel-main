...
var WebSocketFactory = class {
  ...
  static detectEnvironment() {
    ...
    const gl =
      typeof globalthis_default !== "undefined" ? globalthis_default : void 0;
  ...
  _encodeJsonUserBroadcastPush(message) {
    ...
    const userPayload =
      (_b =
        ...
        ? _b
        : {};
    const encodedUserPayload = new TextEncoder().encode(
...
var PresenceAdapter = class PresenceAdapter {
  constructor(channel, opts) {
    ...
    this.presence.onJoin((key, currentPresence, newPresence) => {
      const onJoinPayload = PresenceAdapter.onJoinPayload(
        key,
        currentPresence,
        newPresence,
      );
    ...
    this.presence.onLeave((key, currentPresence, leftPresence) => {
      const onLeavePayload = PresenceAdapter.onLeavePayload(
        key,
        currentPresence,
        leftPresence,
      );
...
var RealtimeChannel = class RealtimeChannel {
  ...
  async httpSend(event, payload, opts = {}) {
    ...
    if (payload === void 0 || payload === null)
      return Promise.reject(
        /* @__PURE__ */ new Error("Payload is required for httpSend()"),
      );
    const isBinary =
  ...
  _on(type, filter, callback) {
    ...
    const filterValue =
      filter === null || filter === void 0 ? void 0 : filter.filter;
    if (
  ...
  _notThisChannelEvent(event, ref) {
    ...
    return (
      ref &&
      [close, error, leave, join].includes(event) &&
      ref !== this.joinPush.ref
    );
  }
  /** @internal */
...
function createMemorySessionStorage() {
  ...
  return {
    ...
    key(index) {
      var _a;
      return (_a = Array.from(store.keys())[index]) !== null && _a !== void 0
        ? _a
        : null;
    },
    removeItem(key) {
...
var RealtimeClient = class {
  ...
  onHeartbeat(callback) {
    this.socketAdapter.heartbeatCallback =
      this._wrapHeartbeatCallback(callback);
  }
  /**
  ...
  _initializeOptions(options) {
    ...
    result.sessionStorage =
      (_h =
        options === null || options === void 0
          ? void 0
          : options.sessionStorage) !== null && _h !== void 0
        ? _h
    ...
    result.reconnectAfterMs =
      (_j =
        options === null || options === void 0
          ? void 0
          : options.reconnectAfterMs) !== null && _j !== void 0
        ? _j
        : (tries) => {
    ...
    let defaultDecode;
    const vsn =
      (_k = options === null || options === void 0 ? void 0 : options.vsn) !==
        null && _k !== void 0
        ? _k
        : DEFAULT_VSN;
    switch (vsn) {
