...
var configSpring = function configSpring() {
  ...
  var stepper = function stepper(currX, destX, currV) {
    var newV =
      currV + ((-(currX - destX) * stiff - currV * damping) * dt) / 1e3;
  ...
  update = easing.isStepper
    ...
    : function timingUpdate(now) {
        ...
        var currStyle = mapObject(function (key, val) {
          return alpha.apply(
            void 0,
            _toConsumableArray$1(val).concat([easing(t)]),
          );
        }, timingStyle);
        render(
          _objectSpread$1(
        ...
        if (t < 1) cafId = requestAnimationFrame(update);
          ...
          var finalStyle = mapObject(function (key, val) {
            return alpha.apply(
              void 0,
              _toConsumableArray$1(val).concat([easing(1)]),
            );
          }, timingStyle);
          render(
            _objectSpread$1(
              ...
              steps.reduce(
                function addStyle(sequence, nextItem, index) {
                  ...
                  var duration = nextItem.duration,
                    ...
                    easing =
                      _nextItem$easing === void 0 ? "ease" : _nextItem$easing,
