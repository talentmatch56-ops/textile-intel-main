...
import {
  ...
  c as require_isBoolean,
  d as require_flatMap,
  f as require_min,
  g as require_throttle,
  h as require_isEqual,
  i as require_range,
  l as require_isPlainObject,
  m as require_upperFirst,
  n as require_maxBy,
  o as require_every,
  p as require_max,
  r as require_some,
  s as require_mapValues,
  t as require_minBy,
  u as require_last,
  v as require_isNaN,
  w as require_memoize,
  x as require_isNil,
  y as require_isNumber,
} from "./lodash.mjs";
...
function _slicedToArray$10(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$17(arr, i) ||
    _nonIterableRest$10()
  );
}
...
function _objectSpread$36(e) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2
      ? ownKeys$36(Object(t), !0).forEach(function (r) {
          _defineProperty$41(e, r, t[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
        : ownKeys$36(Object(t)).forEach(function (r) {
...
var DefaultTooltipContent = function DefaultTooltipContent(props) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.isValidElement(finalLabel)
        ? finalLabel
        : "".concat(finalLabel),
    ),
    renderContent(),
...
function _defineProperties$21(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$40(descriptor.key),
      descriptor,
    );
  }
}
...
function _callSuper$18(t, o, e) {
  return (
    (o = _getPrototypeOf$18(o)),
    _possibleConstructorReturn$18(
      t,
      _isNativeReflectConstruct$18()
        ? Reflect.construct(o, e || [], _getPrototypeOf$18(t).constructor)
        : o.apply(t, e),
    )
  );
}
function _possibleConstructorReturn$18(self, call) {
  if (call && (_typeof$42(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
...
function _getPrototypeOf$18(o) {
  _getPrototypeOf$18 = Object.setPrototypeOf
...
function _setPrototypeOf$18(o, p) {
  _setPrototypeOf$18 = Object.setPrototypeOf
...
var TooltipBoundingBox = /*#__PURE__*/ (function (_PureComponent) {
  function TooltipBoundingBox() {
    ...
    _defineProperty$39(_this, "state", {
      dismissed: false,
    ...
    _defineProperty$39(_this, "handleKeyDown", function (event) {
      if (event.key === "Escape") {
  ...
  return _createClass$21(TooltipBoundingBox, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var outerStyle = _objectSpread$35(
          _objectSpread$35(
            {
              transition:
...
function _defineProperties$20(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$39(descriptor.key),
      descriptor,
    );
  }
}
...
function _possibleConstructorReturn$17(self, call) {
  if (call && (_typeof$41(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
      "Derived constructors may only return object or undefined",
...
var adaptEventsOfChild = function adaptEventsOfChild(props, data, index) {
  if (!(0, import_isObject.default)(props) || _typeof$40(props) !== "object")
    return null;
  var out = null;
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
  if (
    (0, import_isNil.default)(nextChild) &&
    (0, import_isNil.default)(prevChild)
  )
    return true;
  if (
    !(0, import_isNil.default)(nextChild) &&
    ...
    var _ref = nextChild.props || {},
      ...
      nextProps = _objectWithoutProperties$19(_ref, _excluded$19);
    var _ref2 = prevChild.props || {},
      prevChildren = _ref2.children,
      prevProps = _objectWithoutProperties$19(_ref2, _excluded2$8);
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)(
  function (_ref, ref) {
    ...
    var setContainerSize = (0, import_react.useCallback)(function (
      newWidth,
      newHeight,
    ) {
...
var Layer = /*#__PURE__*/ import_react.forwardRef(function (props, ref) {
  var children = props.children,
    ...
    others = _objectWithoutProperties$18(props, _excluded$18);
  var layerClass = clsx("recharts-layer", className);
  return /*#__PURE__*/ import_react.createElement(
    "g",
    _extends$30({ className: layerClass }, filterProps(others, true), { ref }),
    children,
  );
});
//#endregion
...
var getPath$1 = function getPath(_ref) {
  ...
  if (Array.isArray(baseLine)) {
    ...
    var areaPoints = formatPoints.map(function (entry, index) {
      return _objectSpread$32(
        _objectSpread$32({}, entry),
        {},
...
var Curve = function Curve(props) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$29({}, filterProps(props, false), adaptEventHandlers(props), {
...
var getStringSize = function getStringSize(text) {
  ...
  try {
    ...
    var measurementSpanStyle = _objectSpread$31(
      _objectSpread$31({}, SPAN_STYLE),
      copyStyle,
    );
...
function _defineProperties$19(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$35(descriptor.key),
      descriptor,
    );
  }
}
...
function calculateParentheses(expr) {
  ...
  while (newExpr.includes("(")) {
    var parentheticalExpression = _slicedToArray$8(
      PARENTHESES_REGEX.exec(newExpr),
      2,
    )[1];
...
var getWordsWithoutCalculate = function getWordsWithoutCalculate(children) {
  return [
    {
      words: !(0, import_isNil.default)(children)
...
var Text = function Text(_ref5) {
  var _ref5$x = _ref5.x,
    ...
    props = _objectWithoutProperties$17(_ref5, _excluded$17);
  ...
  var dx = props.dx,
    ...
    className = props.className,
    breakAll = props.breakAll,
    textProps = _objectWithoutProperties$17(props, _excluded2$7);
  ...
  return /*#__PURE__*/ import_react.createElement(
    "text",
    _extends$28({}, filterProps(textProps, true), {
      x,
      y,
...
function _toConsumableArray$8(arr) {
  return (
    ...
    _unsupportedIterableToArray$13(arr) ||
...
function _slicedToArray$6(arr, i) {
  return (
    ...
    _unsupportedIterableToArray$12(arr, i) ||
    _nonIterableRest$6()
  );
}
...
function getFormatStep(roughStep, allowDecimals, correctionFactor) {
  ...
  var formatStep = new decimal_default(
  ...
  return allowDecimals
    ? formatStep
    : new decimal_default(Math.ceil(formatStep));
}
/**
...
function calculateStep(min, max, tickCount, allowDecimals) {
  ...
  var upCount = Math.ceil(
    new decimal_default(max).sub(middle).div(step).toNumber(),
  );
...
function _defineProperties$18(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$34(descriptor.key),
      descriptor,
    );
  }
}
...
function _possibleConstructorReturn$16(self, call) {
  if (call && (_typeof$34(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
      "Derived constructors may only return object or undefined",
  ...
  return _createClass$18(ErrorBar, [
    {
      ...
      value: function render() {
        ...
        var svgProps = filterProps(
          _objectWithoutProperties$16(_this$props, _excluded$16),
          false,
        );
...
function Surface(props) {
  var children = props.children,
    ...
    title = props.title,
    desc = props.desc,
    others = _objectWithoutProperties$15(props, _excluded$15);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /*#__PURE__*/ import_react.createElement(
    "svg",
    _extends$26({}, filterProps(others, true, "svg"), {
...
var _excluded$14 = ["type", "size", "sizeType"];
...
var getSymbolFactory = function getSymbolFactory(type) {
  return (
    symbolFactories["symbol".concat((0, import_upperFirst.default)(type))] ||
    circle_default
  );
};
...
var Symbols = function Symbols(_ref) {
  ...
  var props = _objectSpread$30(
    _objectSpread$30({}, _objectWithoutProperties$14(_ref, _excluded$14)),
    {},
    {
      type,
      size,
...
function _defineProperties$17(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$32(descriptor.key),
      descriptor,
    );
  }
}
...
function _possibleConstructorReturn$15(self, call) {
  if (call && (_typeof$32(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
      "Derived constructors may only return object or undefined",
  ...
  return _createClass$17(DefaultLegendContent, [
    {
      ...
      value: function renderIcon(data) {
        ...
        if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
          ...
          return /*#__PURE__*/ import_react.cloneElement(
            data.legendIcon,
            iconProps,
          );
        }
    ...
    },
    {
      ...
      value: function renderItems() {
        ...
        return payload.map(function (entry, i) {
          ...
          if (entry.type === "none") return null;
          var entryValue = !(0, import_isFunction.default)(entry.value)
            ? entry.value
            : null;
          warn(
...
function _defineProperties$16(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$31(descriptor.key),
      descriptor,
    );
  }
}
...
function _possibleConstructorReturn$14(self, call) {
  if (call && (_typeof$31(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
      "Derived constructors may only return object or undefined",
      ...
      },
      {
        ...
        value: function getBBoxSnapshot() {
          if (
            ...
            return _objectSpread$28({}, this.lastBoundingBox);
          return {
            width: 0,
            height: 0,
          };
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            payload = _this$props2.payload;
          var outerStyle = _objectSpread$28(
            _objectSpread$28(
              {
                position: "absolute",
                width: width || "auto",
    ...
    [
      {
        ...
        value: function getWithHeight(item, chartWidth) {
          var layout = _objectSpread$28(
            _objectSpread$28({}, this.defaultProps),
            item.props,
          ).layout;
          if (layout === "vertical" && isNumber(item.props.height))
            return { height: item.props.height };
          if (layout === "horizontal")
            return { width: item.props.width || chartWidth };
          return null;
        },
      },
    ],
...
var getLegendProps = function getLegendProps(_ref) {
  ...
  var legendProps =
    legendDefaultProps !== void 0
      ? _objectSpread$27(
          _objectSpread$27({}, legendDefaultProps),
          legendItem.props,
        )
      : {};
  var legendData;
...
function _toConsumableArray$6(arr) {
  return (
    ...
    _unsupportedIterableToArray$10(arr) ||
...
function getValueByDataKey(obj, dataKey, defaultValue) {
  if ((0, import_isNil.default)(obj) || (0, import_isNil.default)(dataKey))
    return defaultValue;
  if (isNumOrStr(dataKey))
    return (0, import_get.default)(obj, dataKey, defaultValue);
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem(item) {
  ...
  var defaultedProps =
    ...
    _item$type.defaultProps
      ? _objectSpread$26(
          _objectSpread$26({}, item.type.defaultProps),
          item.props,
        )
      : item.props;
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps =
          barItemDefaultProps !== void 0
            ? _objectSpread$26(
                _objectSpread$26({}, barItemDefaultProps),
                barItems[0].props,
              )
            : barItems[0].props;
        ...
        var barSize = (0, import_isNil.default)(selfSize)
          ? globalSize
          : selfSize;
        result[cateId].push({
          item: barItems[0],
...
var appendOffsetOfLegend = function appendOffsetOfLegend(
  offset,
  _unused,
  props,
  legendBox,
...
var getDomainOfErrorBars = function getDomainOfErrorBars(
  data,
  item,
  dataKey,
  layout,
  ...
  var errorBars = findAllByType(children, ErrorBar).filter(
    ...
    return data.reduce(
      function (result, entry) {
        ...
        var mainValue = Array.isArray(entryValue)
          ? [
              (0, import_min.default)(entryValue),
              (0, import_max.default)(entryValue),
            ]
...
var parseErrorBarsOfAxis = function parseErrorBarsOfAxis(
  data,
  items,
  dataKey,
  axisType,
 ...
 */
var getCoordinatesOfGrid = function getCoordinatesOfGrid(
  ticks,
  minValue,
  maxValue,
  syncWithTicks,
  ...
  if (isGrid && (axis.ticks || axis.niceTicks))
    return (axis.ticks || axis.niceTicks)
      .map(function (entry) {
        return {
          coordinate:
            scale(duplicateDomain ? duplicateDomain.indexOf(entry) : entry) +
            offset,
          value: entry,
          offset,
        };
...
var STACK_OFFSET_MAP = {
  sign: function offsetSign(series) {
    ...
    for (var j = 0, m = series[0].length; j < m; ++j) {
      ...
      var negative = 0;
      for (var i = 0; i < n; ++i) {
        var value = (0, import_isNaN.default)(series[i][j][1])
          ? series[i][j][0]
          : series[i][j][1];
        if (value >= 0) {
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(
  ...
  if (!data) return null;
  var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(
...
var getTicksOfScale = function getTicksOfScale(scale, opts) {
  ...
  if (
    ...
    scale.domain([
      (0, import_min.default)(tickValues),
      (0, import_max.default)(tickValues),
    ]);
...
var getDomainOfStackGroups = function getDomainOfStackGroups(
  stackGroups,
  startIndex,
  endIndex,
) {
...
var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps
    ? _objectSpread$26(
        _objectSpread$26({}, graphicalItem.type.defaultProps),
        graphicalItem.props,
      )
    : graphicalItem.props;
 ...
 */
var formatAxisMap$1 = function formatAxisMap(
  props,
  axisMap,
  offset,
  axisType,
...
var distanceBetweenPoints = function distanceBetweenPoints(
  point,
  anotherPoint,
) {
  var x1 = point.x,
...
var getLabel = function getLabel(props) {
  var value = props.value,
    formatter = props.formatter;
  var label = (0, import_isNil.default)(props.children)
    ? value
    : props.children;
...
function Label(_ref4) {
  var _ref4$offset = _ref4.offset,
    ...
    restProps = _objectWithoutProperties$12(_ref4, _excluded$12);
...
var renderCallByParent$1 = function renderCallByParent(parentProps, viewBox) {
  ...
  var explicitChildren = findAllByType(children, Label).map(
  ...
  return [parseLabel(parentProps.label, viewBox || parentViewBox)].concat(
    _toConsumableArray$5(explicitChildren),
  );
};
...
function LabelList(_ref) {
  var _ref$valueAccessor = _ref.valueAccessor,
    ...
    restProps = _objectWithoutProperties$11(_ref, _excluded$11);
  var data = restProps.data,
    dataKey = restProps.dataKey,
    clockWise = restProps.clockWise,
    id = restProps.id,
    textBreakAll = restProps.textBreakAll,
    others = _objectWithoutProperties$11(restProps, _excluded2$6);
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    data.map(function (entry, index) {
      ...
      var idProps = (0, import_isNil.default)(id)
        ? {}
...
function parseLabelList(label, data) {
  ...
  if (
    /*#__PURE__*/ import_react.isValidElement(label) ||
    (0, import_isFunction.default)(label)
  )
    return /*#__PURE__*/ import_react.createElement(LabelList, {
      key: "labelList-implicit",
      data,
...
function renderCallByParent(parentProps, data) {
  ...
  if (
    ...
    return null;
  var children = parentProps.children;
  var explicitChildren = findAllByType(children, LabelList).map(
    function (child, index) {
      return /*#__PURE__*/ (0, import_react.cloneElement)(child, {
        data,
  ...
  if (!checkPropsLabel) return explicitChildren;
  return [parseLabelList(parentProps.label, data)].concat(
...
var Rectangle = function Rectangle(rectangleProps) {
  var props = _objectSpread$22(
    _objectSpread$22({}, defaultProps$3),
    rectangleProps,
  );
...
var getTrapezoidPath = function getTrapezoidPath(
  x,
  y,
  upperWidth,
  lowerWidth,
  ...
  path += "L "
    .concat(x + upperWidth - widthGap / 2 - lowerWidth, ",")
    .concat(y + height);
...
var Trapezoid = function Trapezoid(props) {
  var trapezoidProps = _objectSpread$21(
    _objectSpread$21({}, defaultProps$2),
    props,
  );
  var pathRef = (0, import_react.useRef)();
  ...
  if (!isUpdateAnimationActive)
    return /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.createElement(
        "path",
        _extends$20({}, filterProps(trapezoidProps, true), {
          className: layerClass,
...
var getDeltaAngle = function getDeltaAngle(startAngle, endAngle) {
  return (
    mathSign(endAngle - startAngle) *
    Math.min(Math.abs(endAngle - startAngle), 359.999)
  );
};
...
var Sector = function Sector(sectorProps) {
  var props = _objectSpread$20(
    _objectSpread$20({}, defaultProps$1),
    sectorProps,
  );
  var cx = props.cx,
    cy = props.cy,
...
function Shape(_ref2) {
  var option = _ref2.option,
    ...
    props = _objectWithoutProperties$10(_ref2, _excluded$10);
  var shape;
  if (/*#__PURE__*/ (0, import_react.isValidElement)(option))
    shape = /*#__PURE__*/ (0, import_react.cloneElement)(
      option,
      _objectSpread$19(
        _objectSpread$19({}, props),
...
function getActiveShapeIndexForTooltip(_ref3) {
  ...
  var activeItemMatches = itemData.filter(function (datum, dataIndex) {
    ...
    var mouseCoordinateMatches = graphicalItem.props[shapeKey].filter(
      function (shapeData) {
        return getComparisonFn(graphicalItem, activeTooltipItem)(
          shapeData,
          activeTooltipItem,
        );
      },
...
function _defineProperties$15(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$21(descriptor.key),
      descriptor,
    );
  }
}
...
function _possibleConstructorReturn$13(self, call) {
  if (call && (_typeof$21(call) === "object" || typeof call === "function"))
    return call;
  else if (call !== void 0)
    throw new TypeError(
      "Derived constructors may only return object or undefined",
      ...
      },
      {
        ...
        value: function renderLabels(sectors) {
          ...
          var labels = sectors.map(function (entry, i) {
            ...
            var labelProps = _objectSpread$18(
              _objectSpread$18(
                _objectSpread$18(_objectSpread$18({}, pieProps), entry),
                {},
                { stroke: "none" },
                customLabelProps,
              ),
            ...
            var lineProps = _objectSpread$18(
              _objectSpread$18(
                _objectSpread$18(_objectSpread$18({}, pieProps), entry),
                {},
                {
            ...
            if (
              (0, import_isNil.default)(dataKey) &&
              (0, import_isNil.default)(valueKey)
            )
              realDataKey = "value";
            ...
            return /*#__PURE__*/ import_react.createElement(
              ...
              labelLine &&
                Pie.renderLabelLineItem(labelLine, lineProps, "line"),
              Pie.renderLabelItem(
                label,
                labelProps,
      ...
      },
      {
        ...
        value: function renderSectorsStatically(sectors) {
          ...
          return sectors.map(function (entry, i) {
            ...
            var sectorProps = _objectSpread$18(
              _objectSpread$18({}, entry),
              {},
              {
          ...
          return /*#__PURE__*/ import_react.createElement(
            ...
            function (_ref2) {
              ...
              sectors.forEach(function (entry, index) {
                ...
                var paddingAngle =
                  index > 0
                    ? (0, import_get.default)(entry, "paddingAngle", 0)
                    : 0;
                if (prev) {
                  ...
                  var deltaAngle = interpolateNumber$1(
                    0,
                    endAngle - startAngle,
                  )(t);
                  var _latest = _objectSpread$18(
                    _objectSpread$18({}, entry),
                    {},
                    {
                      startAngle: curAngle + paddingAngle,
        ...
        value: function renderLabelItem(option, props, value) {
          ...
          var className = clsx(
            ...
            typeof option !== "boolean" &&
              !(0, import_isFunction.default)(option)
              ? option.className
              : "",
          );
          return /*#__PURE__*/ import_react.createElement(
...
_defineProperty$21(Pie, "getRealPieData", function (itemProps) {
  ...
  if (data && data.length)
    return data.map(function (entry, index) {
      return _objectSpread$18(
        _objectSpread$18(
          _objectSpread$18({ payload: entry }, presentationProps),
          entry,
        ),
  ...
  if (cells && cells.length)
    return cells.map(function (cell) {
      return _objectSpread$18(
        _objectSpread$18({}, presentationProps),
        cell.props,
      );
    });
  return [];
...
_defineProperty$21(Pie, "getComposedData", function (_ref4) {
  ...
  var itemProps =
    item.type.defaultProps !== void 0
      ? _objectSpread$18(
          _objectSpread$18({}, item.type.defaultProps),
          item.props,
        )
      : item.props;
...
function typeguardBarRectangleProps(_ref, props) {
  var xProp = _ref.x,
    yProp = _ref.y,
    option = _objectWithoutProperties$9(_ref, _excluded$9);
  ...
  return _objectSpread$17(
    _objectSpread$17(
      _objectSpread$17(
        _objectSpread$17(_objectSpread$17({}, props), option),
        x ? { x } : {},
      ),
      y ? { y } : {},
    ),
...
function _defineProperties$14(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$19(descriptor.key),
      descriptor,
    );
  }
}
    ...
    [
          ...
          return (
            ...
            data.map(function (entry, i) {
              ...
              var props = _objectSpread$16(
                _objectSpread$16(_objectSpread$16({}, baseProps), entry),
                {},
                {
                  isActive,
                  option,
            ...
            function (_ref) {
              ...
              var stepData = data.map(function (entry, index) {
                ...
                if (prev) {
                  ...
                  var interpolatorWidth = interpolateNumber$1(
                    prev.width,
                    entry.width,
                  );
                  var interpolatorHeight = interpolateNumber$1(
                    prev.height,
                    entry.height,
                  );
                  return _objectSpread$16(
                    _objectSpread$16({}, entry),
                    {},
                    {
                      x: interpolatorX(t),
                      y: interpolatorY(t),
        ...
        value: function renderBackground() {
          ...
          return data.map(function (entry, i) {
            ...
            var background = entry.background,
              rest = _objectWithoutProperties$8(entry, _excluded$8);
            if (!background) return null;
            var props = _objectSpread$16(
              _objectSpread$16(
                _objectSpread$16(
                  _objectSpread$16(
                    _objectSpread$16({}, rest),
                    {},
                    { fill: "#eee" },
                    background,
                  ),
      ...
      },
      {
        ...
        value: function renderErrorBar(needClip, clipPathId) {
          ...
          var dataPointFormatter = function dataPointFormatter(
            dataPoint,
            dataKey,
          ) {
            /**
...
_defineProperty$19(Bar, "getComposedData", function (_ref2) {
  ...
  var itemProps =
    itemDefaultProps !== void 0
      ? _objectSpread$16(_objectSpread$16({}, itemDefaultProps), item.props)
      : item.props;
  var dataKey = itemProps.dataKey,
    children = itemProps.children,
...
function _defineProperties$13(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$18(descriptor.key),
      descriptor,
    );
  }
}
 ...
 * @return {Object} Configuration
 */
var formatAxisMap = function formatAxisMap(
  props,
  axisMap,
  offset,
  axisType,
  ...
  return ids.reduce(function (result, id) {
    ...
    var ticks = getTicksOfScale(
      scale,
      _objectSpread$15(_objectSpread$15({}, axis), {}, { realScaleType }),
    );
    if (axisType === "xAxis") {
      needSpace =
    ...
    var finalAxis = _objectSpread$15(
      _objectSpread$15(_objectSpread$15({}, axis), ticks),
      {},
      {
        realScaleType,
        x,
    ...
    return _objectSpread$15(
      _objectSpread$15({}, result),
      {},
      _defineProperty$18({}, id, finalAxis),
    );
  }, {});
};
...
var createLabeledScales = function createLabeledScales(options) {
  var scales = Object.keys(options).reduce(function (res, key) {
    return _objectSpread$15(
      _objectSpread$15({}, res),
      {},
      _defineProperty$18({}, key, ScaleHelper.create(options[key])),
    );
  }, {});
  return _objectSpread$15(
    _objectSpread$15({}, scales),
    {},
    {
...
function getEquidistantTicks(sign, boundaries, getTickSize, ticks, minTickGap) {
  ...
  var _loop = function _loop() {
      ...
      if (entry === void 0)
        return { v: getEveryNthWithCondition(ticks, stepsize) };
      var i = index;
      var size;
      ...
      var isShow =
        index === 0 || isVisible(sign, tickCoord, getSize, start, end);
      if (!isShow) {
        index = 0;
        start = initialStart;
        stepsize += 1;
...
function getTicksEnd(sign, boundaries, getTickSize, ticks, minTickGap) {
  ...
  var _loop = function _loop(i) {
    ...
    if (i === len - 1) {
      ...
      result[i] = entry = _objectSpread$14(
...
function getTicksStart(
  ...
  if (preserveEnd) {
    ...
    result[len - 1] = tail = _objectSpread$14(
      _objectSpread$14({}, tail),
      {},
      {
        tickCoord:
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var sign =
    ticks.length >= 2 ? mathSign(ticks[1].coordinate - ticks[0].coordinate) : 1;
...
function _defineProperties$12(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$16(descriptor.key),
      descriptor,
    );
  }
}
    ...
    [
      {
        ...
        value: function shouldComponentUpdate(_ref, nextState) {
          ...
          var _this$props = this.props,
            ...
            restPropsOld = _objectWithoutProperties$7(
              _this$props,
              _excluded2$5,
            );
          return (
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread$13(
            _objectSpread$13(
              _objectSpread$13({}, filterProps(this.props, false)),
      ...
      },
      {
        ...
        value: function renderTicks(ticks, fontSize, letterSpacing) {
          ...
          var finalTicks = getTicks(
            _objectSpread$13(_objectSpread$13({}, this.props), {}, { ticks }),
            fontSize,
            letterSpacing,
          );
          ...
          var tickLineProps = _objectSpread$13(
            _objectSpread$13({}, axisProps),
            {},
            { fill: "none" },
          ...
          var items = finalTicks.map(function (entry, i) {
            ...
            var tickProps = _objectSpread$13(
              _objectSpread$13(
                _objectSpread$13(
                  _objectSpread$13(
                    {
            ...
            return /*#__PURE__*/ import_react.createElement(
              ...
              tickLine &&
                /*#__PURE__*/ import_react.createElement(
                  "line",
                  _extends$15({}, tickLineProps, lineCoord, {
                    className: clsx(
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props8 = this.props,
            ...
            noTicksProps = _objectWithoutProperties$7(_this$props8, _excluded3);
...
var useYAxisWithFiniteDomainOrRandom =
  function useYAxisWithFiniteDomainOrRandom() {
...
function renderLineItem(option, props) {
  ...
  if (/*#__PURE__*/ import_react.isValidElement(option))
    ...
    _filterProps.offset;
    var restOfFilteredProps = _objectWithoutProperties$6(
      _filterProps,
      _excluded2$4,
    );
    lineItem = /*#__PURE__*/ import_react.createElement(
      "line",
      _extends$14({}, restOfFilteredProps, {
        x1,
        y1,
        x2,
        y2,
...
var defaultVerticalCoordinatesGenerator =
  function defaultVerticalCoordinatesGenerator(_ref, syncWithTicks) {
    ...
    return getCoordinatesOfGrid(
      getTicks(
        _objectSpread$12(
          _objectSpread$12(
            _objectSpread$12({}, CartesianAxis.defaultProps),
            xAxis,
          ),
          {},
          {
...
var defaultHorizontalCoordinatesGenerator =
  function defaultHorizontalCoordinatesGenerator(_ref2, syncWithTicks) {
...
function CartesianGrid(props) {
  ...
  var propsIncludingDefaults = _objectSpread$12(
    _objectSpread$12({}, props),
    {},
    {
      stroke:
  ...
  return /*#__PURE__*/ import_react.createElement(
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalGridLines,
      _extends$14({}, propsIncludingDefaults, {
        offset,
        horizontalPoints,
        xAxis,
        yAxis,
    ...
    /*#__PURE__*/ import_react.createElement(
      HorizontalStripes,
      _extends$14({}, propsIncludingDefaults, { horizontalPoints }),
    ),
    /*#__PURE__*/ import_react.createElement(
      VerticalStripes,
      _extends$14({}, propsIncludingDefaults, { verticalPoints }),
    ),
  );
}
...
var Dot = function Dot(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r)
    return /*#__PURE__*/ import_react.createElement(
      "circle",
      _extends$13({}, filterProps(props, false), adaptEventHandlers(props), {
        className: layerClass,
        cx,
        cy,
        r,
 ...
 * @fileOverview Line
 */
var _excluded$5 = ["type", "layout", "connectNulls", "ref"],
  _excluded2$3 = ["key"];
...
function _defineProperties$11(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$14(descriptor.key),
      descriptor,
    );
  }
}
  ...
  function Line() {
    ...
    _defineProperty$14(
      ...
      function (length, totalLength, lines) {
        ...
        return []
          .concat(
            _toConsumableArray$3(Line.repeat(lines, count)),
    ...
    [
      ...
      },
      {
        ...
        value: function renderCurveStatically(
          ...
          _this$props3.ref;
          var curveProps = _objectSpread$11(
            _objectSpread$11(
              _objectSpread$11(
                {},
                filterProps(
                  _objectWithoutProperties$5(_this$props3, _excluded$5),
                  true,
                ),
              ),
              {},
          ...
          return /*#__PURE__*/ import_react.createElement(
            Curve,
            _extends$12({}, curveProps, { pathRef: this.pathRef }),
          );
        },
      },
      {
            ...
            function (_ref) {
              ...
              if (prevPoints) {
                ...
                var stepData = points.map(function (entry, index) {
                  ...
                  if (animateNewValues) {
                    var _interpolatorX = interpolateNumber$1(
                      width * 2,
                      entry.x,
                    );
                    var _interpolatorY = interpolateNumber$1(
                      height / 2,
                      entry.y,
                    );
                    return _objectSpread$11(
    ...
    [
      {
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
          ...
          if (nextProps.points !== prevState.curPoints)
            return { curPoints: nextProps.points };
          return null;
        },
      },
      {
        ...
        value: function repeat(lines, count) {
          var linesUnit =
            lines.length % 2 !== 0
              ? [].concat(_toConsumableArray$3(lines), [0])
              : lines;
          var result = [];
          for (var i = 0; i < count; ++i)
            result = [].concat(
      ...
      },
      {
        ...
        value: function renderDotItem(option, props) {
          ...
          if (/*#__PURE__*/ import_react.isValidElement(option))
            ...
            var key = props.key,
              dotProps = _objectWithoutProperties$5(props, _excluded2$3);
            var className = clsx(
              "recharts-line-dot",
              typeof option !== "boolean" ? option.className : "",
            );
            dotItem = /*#__PURE__*/ import_react.createElement(
              Dot,
              _extends$12({ key }, dotProps, { className }),
            );
          }
          return dotItem;
        },
...
function _defineProperties$10(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$13(descriptor.key),
      descriptor,
    );
  }
}
    ...
    [
      {
        ...
        value: function renderDots(needClip, clipDot, clipPathId) {
          ...
          return /*#__PURE__*/ import_react.createElement(
            Layer,
            _extends$11({ className: "recharts-area-dots" }, dotsProps),
            dots,
          );
        },
      },
      ...
      },
      {
        ...
        value: function renderAreaStatically(
          ...
          return /*#__PURE__*/ import_react.createElement(
            ...
            /*#__PURE__*/ import_react.createElement(
              Curve,
              _extends$11({}, filterProps(others, true), {
                points,
                connectNulls,
                type,
                baseLine,
            ...
            stroke !== "none" &&
              /*#__PURE__*/ import_react.createElement(
                Curve,
                _extends$11({}, filterProps(this.props, false), {
            ...
            function (_ref) {
              ...
              if (prevPoints) {
                ...
                if (isNumber(baseLine) && typeof baseLine === "number")
                  ...
                  (0, import_isNil.default)(baseLine) ||
                  (0, import_isNaN.default)(baseLine)
                )
...
_defineProperty$13(Area, "renderDotItem", function (option, props) {
  ...
  if (/*#__PURE__*/ import_react.isValidElement(option))
    ...
    var key = props.key,
      rest = _objectWithoutProperties$4(props, _excluded2$2);
    dotItem = /*#__PURE__*/ import_react.createElement(
      Dot,
      _extends$11({}, rest, {
        key,
...
function _defineProperties$9(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$12(descriptor.key),
      descriptor,
    );
  }
}
...
function _defineProperties$8(target, props) {
  for (var i = 0; i < props.length; i++) {
    ...
    Object.defineProperty(
      target,
      _toPropertyKey$11(descriptor.key),
      descriptor,
    );
  }
}
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function (res, entry) {
    return _objectSpread$9(
      _objectSpread$9({}, res),
      {},
      _defineProperty$10({}, entry + camelName, value),
    );
  }, {});
  result[name] = value;
  return result;
    ...
    [
      ...
      },
      {
        ...
        value: function getTextOfTick(index) {
          ...
          return (0, import_isFunction.default)(tickFormatter)
      ...
      },
      {
        ...
        value: function handleTravellerMove(e) {
          ...
          this.setState(
            _defineProperty$9(
              _defineProperty$9({}, movingTravellerId, prevValue + delta),
              "brushMoveStartX",
              e.pageX,
            ),
            function () {
      ...
      },
      {
        ...
        value: function renderTravellerLayer(travellerX, id) {
          ...
          var travellerProps = _objectSpread$8(
            _objectSpread$8({}, filterProps(this.props, false)),
            {},
            {
              x,
              y,
...
var renderLine = function renderLine(option, props) {
  ...
  if (/*#__PURE__*/ import_react.isValidElement(option))
    ...
    line = /*#__PURE__*/ import_react.createElement(
      "line",
      _extends$6({}, props, { className: "recharts-reference-line-line" }),
    );
  return line;
};
...
var getRect = function getRect(hasX1, hasX2, hasY1, hasY2, props) {
  ...
  var p1 = {
    x: hasX1
      ? scales.x.apply(xValue1, { position: "start" })
      : scales.x.rangeMin,
    y: hasY1
      ? scales.y.apply(yValue1, { position: "start" })
      : scales.y.rangeMin,
  };
  var p2 = {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ import_react.createElement(
          ...
          ReferenceArea.renderRect(
            shape,
            _objectSpread$5(
              _objectSpread$5({ clipPath }, filterProps(this.props, true)),
              rect,
            ),
          ),
...
_defineProperty$6(ReferenceArea, "renderRect", function (option, props) {
  ...
  if (/*#__PURE__*/ import_react.isValidElement(option))
    ...
    rect = /*#__PURE__*/ import_react.createElement(
      Rectangle,
      _extends$5({}, props, { className: "recharts-reference-area-rect" }),
    );
  return rect;
});
//#endregion
...
var detectReferenceElementsDomain = function detectReferenceElementsDomain(
  ...
  var elements = [].concat(
    _toConsumableArray$2(lines),
    _toConsumableArray$2(dots),
  );
...
var Cross = function Cross(_ref) {
  ...
  return /*#__PURE__*/ import_react.createElement(
    "path",
    _extends$4({}, filterProps(props, true), {
...
function Cursor(props) {
  ...
  var cursorProps = _objectSpread$3(
    _objectSpread$3(
      _objectSpread$3(
        _objectSpread$3(
          {
...
var getDisplayedData = function getDisplayedData(data, _ref) {
  ...
  var itemsData = (
    ...
    if (itemData && itemData.length)
      return [].concat(
        _toConsumableArray$1(result),
        _toConsumableArray$1(itemData),
      );
    return result;
  }, []);
...
var getTooltipContent = function getTooltipContent(
  ...
  return graphicalItems.reduce(function (result, child) {
    ...
    return [].concat(_toConsumableArray$1(result), [
  ...
  return axes.reduce(function (result, child) {
    ...
    var childProps =
      child.type.defaultProps !== void 0
        ? _objectSpread$2(
            _objectSpread$2({}, child.type.defaultProps),
            child.props,
          )
        : child.props;
    ...
    return _objectSpread$2(
      _objectSpread$2({}, result),
      {},
      _defineProperty$2(
        {},
        axisId,
        _objectSpread$2(
          _objectSpread$2({}, childProps),
          {},
          {
            axisType,
            domain,
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread$2(
        ...
        _defineProperty$2(
          ...
          axisId,
          _objectSpread$2(
            _objectSpread$2({ axisType }, Axis.defaultProps),
            {},
            {
              hide: true,
...
var calculateOffset = function calculateOffset(_ref5, prevLegendBBox) {
    ...
    function (result, id) {
      ...
      if (!entry.mirror && !entry.hide)
        return _objectSpread$2(
          _objectSpread$2({}, result),
          {},
          _defineProperty$2({}, orientation, result[orientation] + entry.width),
        );
      return result;
    },
    {
          ...
          if (!entry.mirror && !entry.hide)
            return _objectSpread$2(
              ...
              _defineProperty$2(
                {},
                orientation,
                (0, import_get.default)(result, "".concat(orientation)) +
                  entry.height,
              ),
            );
          return result;
  ...
  return _objectSpread$2(
    _objectSpread$2({ brushBottom }, offset),
    {},
    {
  ...
  var getFormatItems = function getFormatItems(props, currentState) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var itemProps =
        item.type.defaultProps !== void 0
          ? _objectSpread$2(
              _objectSpread$2({}, item.type.defaultProps),
              item.props,
            )
          : item.props;
      var dataKey = itemProps.dataKey,
      ...
      var axisObj = axisComponents.reduce(function (result, entry) {
        ...
        return _objectSpread$2(
          ...
          {},
          _defineProperty$2(
            _defineProperty$2({}, entry.axisType, axis),
  ...
  var CategoricalChartWrapper = /*#__PURE__*/ (function (_Component) {
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty$2(_this, "handleMouseEnter", function (e) {
        ...
        if (mouse) {
          var _nextState = _objectSpread$2(
            _objectSpread$2({}, mouse),
            {},
          ...
          if ((0, import_isFunction.default)(onMouseEnter))
      ...
      _defineProperty$2(_this, "triggeredAfterMouseMove", function (e) {
        ...
        if ((0, import_isFunction.default)(onMouseMove))
      ...
      _defineProperty$2(_this, "handleMouseLeave", function (e) {
        ...
        if ((0, import_isFunction.default)(onMouseLeave))
      ...
      _defineProperty$2(_this, "handleOuterEvent", function (e) {
        ...
        if (eventName && (0, import_isFunction.default)(event)) {
          ...
          event(
            (_mouse = mouse) !== null && _mouse !== void 0 ? _mouse : {},
            e,
          );
        }
      });
      _defineProperty$2(_this, "handleClick", function (e) {
        var mouse = _this.getMouseInfo(e);
        if (mouse) {
          var _nextState2 = _objectSpread$2(
            _objectSpread$2({}, mouse),
            {},
            { isTooltipActive: true },
          );
      ...
      _defineProperty$2(_this, "handleMouseDown", function (e) {
        ...
        if ((0, import_isFunction.default)(onMouseDown))
          onMouseDown(_this.getMouseInfo(e), e);
      });
      _defineProperty$2(_this, "handleMouseUp", function (e) {
        var onMouseUp = _this.props.onMouseUp;
        if ((0, import_isFunction.default)(onMouseUp))
          onMouseUp(_this.getMouseInfo(e), e);
      });
      ...
      _defineProperty$2(_this, "handleDoubleClick", function (e) {
        ...
        if ((0, import_isFunction.default)(onDoubleClick))
          onDoubleClick(_this.getMouseInfo(e), e);
      });
      _defineProperty$2(_this, "handleContextMenu", function (e) {
        var onContextMenu = _this.props.onContextMenu;
        if ((0, import_isFunction.default)(onContextMenu))
          onContextMenu(_this.getMouseInfo(e), e);
      });
      ...
      _defineProperty$2(_this, "applySyncEvent", function (data) {
        ...
        if (data.dataStartIndex !== void 0 || data.dataEndIndex !== void 0)
          ...
          var viewBox = _objectSpread$2(
            _objectSpread$2({}, offset),
            {},
            {
              x: offset.left,
              y: offset.top,
      ...
      _defineProperty$2(
        ...
        function (element, displayName, index) {
          ...
          var axisMap = (0, import_get.default)(
            _this.state,
            "".concat(axisType, "Map"),
          );
          ...
          var elementProps =
            elementDefaultProps !== void 0
              ? _objectSpread$2(
                  _objectSpread$2({}, elementDefaultProps),
                  element.props,
                )
              : element.props;
          var axisOption =
      ...
      _defineProperty$2(_this, "renderLegend", function () {
        ...
        return /*#__PURE__*/ (0, import_react.cloneElement)(
          item,
          _objectSpread$2(
            _objectSpread$2({}, _objectWithoutProperties$2(props, _excluded$2)),
            {},
            {
              chartWidth: width,
              chartHeight: height,
      ...
      _defineProperty$2(_this, "renderActivePoints", function (_ref10) {
        ...
        var itemItemProps =
          item.item.type.defaultProps !== void 0
            ? _objectSpread$2(
                _objectSpread$2({}, item.item.type.defaultProps),
                item.item.props,
              )
            : item.item.props;
      ...
      _defineProperty$2(
        ...
        function (element, displayName, index) {
          ...
          var graphicalItem = /*#__PURE__*/ (0, import_react.cloneElement)(
            element,
            _objectSpread$2(_objectSpread$2({}, item.props), itemEvents),
          );
    ...
    return _createClass$2(CategoricalChartWrapper, [
      ...
      },
      {
        ...
        value: function displayDefaultTooltip() {
          ...
          if (scatterPlotElement) {
            activeCoordinate = _objectSpread$2(
              _objectSpread$2({}, activeCoordinate),
      ...
      },
      {
        ...
        value: function getMouseInfo(event) {
          ...
          if (toolTipData)
            return _objectSpread$2(_objectSpread$2({}, e), toolTipData);
          return null;
        },
      },
      {
      ...
      },
      {
        ...
        value: function parseEventsOfWrapper() {
          ...
          return _objectSpread$2(
            _objectSpread$2(
              {},
              adaptEventHandlers(this.props, this.handleOuterEvent),
            ),
            tooltipEvents,
          );
        },
          ...
          return xAxisMap
            ? Object.entries(xAxisMap).reduce(function (res, _ref13) {
                ...
                return _objectSpread$2(
                  _objectSpread$2({}, res),
                  {},
                  _defineProperty$2({}, axisId, axisProps.scale),
                );
              }, {})
            : null;
        },
          ...
          if (formattedGraphicalItems && formattedGraphicalItems.length)
            for (
              ...
              if (itemDisplayName === "Bar") {
                ...
                return {
                  graphicalItem: _objectSpread$2(
                    _objectSpread$2({}, graphicalItem),
                    {},
                    { childIndex },
                  ),
      ...
      },
      {
        ...
        value: function render() {
          ...
          var attrs = filterProps(
            _objectWithoutProperties$2(_this$props6, _excluded2$1),
            false,
          );
          if (compact)
            return /*#__PURE__*/ import_react.createElement(
  ...
  _defineProperty$2(
    ...
    function (nextProps, prevState) {
      ...
      if (prevState.updateId === void 0) {
        ...
        return _objectSpread$2(
          _objectSpread$2(
            _objectSpread$2({}, defaultState),
            {},
            { updateId: 0 },
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread$2(
                _objectSpread$2({ props: nextProps }, defaultState),
                {},
                { updateId: 0 },
              ),
              prevState,
      ...
      if (
        ...
        var updatesToState = _objectSpread$2(
          _objectSpread$2({}, getTooltipData(prevState, data, layout)),
          {},
          { updateId: prevState.updateId + 1 },
        );
        var newState = _objectSpread$2(
          _objectSpread$2(
            _objectSpread$2({}, _defaultState),
            keepFromPrevState,
          ),
          updatesToState,
        );
        return _objectSpread$2(
          _objectSpread$2(
            _objectSpread$2({}, newState),
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread$2({ props: nextProps }, newState),
              prevState,
            ),
          ),
          {},
      ...
      if (!isChildrenEqual(children, prevState.prevChildren)) {
        ...
        return _objectSpread$2(
          _objectSpread$2(
            ...
            updateStateOfAxisMapsOffsetAndStackGroups(
              _objectSpread$2(
                _objectSpread$2({ props: nextProps }, prevState),
                {},
                {
                  updateId: newUpdateId,
                  dataStartIndex: startIndex,
...
var Polygon = function Polygon(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /*#__PURE__*/ import_react.createElement(
      ...
      /*#__PURE__*/ import_react.createElement(
        "path",
        _extends$2({}, filterProps(others, true), {
        ...
        value: function renderTicks() {
          ...
          var items = ticks.map(function (entry, i) {
            ...
            var tickProps = _objectSpread$1(
              _objectSpread$1(
                _objectSpread$1(
                  { textAnchor: _this.getTickTextAnchor(entry) },
                  axisProps,
                ),
                {},
                {
      ...
      },
      {
        ...
        value: function renderAxisLine() {
          ...
          var props = _objectSpread(
            _objectSpread(
              _objectSpread({}, filterProps(others, false)),
              {},
              { fill: "none" },
              filterProps(axisLine, false),
            ),
          ...
          return /*#__PURE__*/ import_react.createElement(
            "line",
            _extends({ className: "recharts-polar-radius-axis-line" }, props),
          );
        },
      },
      {
