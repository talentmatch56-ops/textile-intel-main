...
if (typeof Deno !== "undefined") {
  ...
  JS_RUNTIME_VERSION =
    typeof process !== "undefined"
      ? (_process$version = process.version) === null ||
...
var fetchWithAuth = (
  ...
  return async (input, init) => {
    ...
    return fetch$1(
      input,
      _objectSpread2(_objectSpread2({}, init), {}, { headers }),
    );
  };
};
...
function applySettingDefaults(options, defaults) {
  ...
  const tracePropagationOptions = normalizeTracePropagation(
    options.tracePropagation,
  );
  const DEFAULT_TRACE_PROPAGATION_OPTIONS$1 = normalizeTracePropagation(
    defaults.tracePropagation,
  );
  const result = {
    ...
    tracePropagation: {
      enabled:
        (_ref =
          (_tracePropagationOpti =
            tracePropagationOptions === null ||
            tracePropagationOptions === void 0
              ? void 0
              : tracePropagationOptions.enabled) !== null &&
          _tracePropagationOpti !== void 0
            ? _tracePropagationOpti
            : DEFAULT_TRACE_PROPAGATION_OPTIONS$1 === null ||
                DEFAULT_TRACE_PROPAGATION_OPTIONS$1 === void 0
              ? void 0
              : DEFAULT_TRACE_PROPAGATION_OPTIONS$1.enabled) !== null &&
        _ref !== void 0
          ? _ref
          : false,
        ...
        (_ref2 =
          ...
          _tracePropagationOpti2 !== void 0
            ...
            : DEFAULT_TRACE_PROPAGATION_OPTIONS$1 === null ||
                DEFAULT_TRACE_PROPAGATION_OPTIONS$1 === void 0
              ? void 0
              : DEFAULT_TRACE_PROPAGATION_OPTIONS$1.respectSamplingDecision) !==
          null && _ref2 !== void 0
          ? _ref2
          : true,
    },
