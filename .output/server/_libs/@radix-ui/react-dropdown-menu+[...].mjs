...
import {
  ...
  d as Presence,
  f as Portal$1,
  g as DismissableLayer,
  h as useFocusGuards,
  l as ReactRemoveScroll,
  m as FocusScope,
  p as useId,
  u as hideOthers,
...
var PopperAnchor = import_react.forwardRef((props, forwardedRef) => {
  ...
  const sideAndAlign =
    ...
    getSideAndAlignFromPlacement(context.placementState);
      ...
      middleware: [
        ...
        hideWhenDetached &&
          hide({
            ...
            ...detectOverflowOptions,
            boundary: hasExplicitBoundaries
              ? detectOverflowOptions.boundary
              : void 0,
          }),
      ],
    });
