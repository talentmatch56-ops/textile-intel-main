...
function AuthPage() {
	...
	async function handleForgotPassword() {
		...
		setLoading(true);
		try {
			const { error } = await supabase.auth.resetPasswordForEmail(email, { redirectTo: typeof window !== "undefined" ? `${window.location.origin}/auth` : void 0 });
	...
	async function handleGoogleSignIn() {
		...
		try {
			const { error } = await supabase.auth.signInWithOAuth({
				provider: "google",
				options: {
					redirectTo: typeof window !== "undefined" ? `${window.location.origin}/app` : void 0,
	...
	async function submit(e) {
		...
		setLoading(true);
		try {
			const res = mode === "signin" ? await supabase.auth.signInWithPassword({
				email,
				password
				...
				password,
				options: {
					emailRedirectTo: typeof window !== "undefined" ? `${window.location.origin}/app` : void 0,
					data: { full_name: name }
				}
			});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 ticker-grid opacity-[0.07]" }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: mode === "signin" ? "Access your terminal" : "Join GMIntel AI"
							})] }),
							...
							err && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-3.5 w-3.5 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: err })]
							}),
							forgotSent && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-2 text-xs text-success bg-success/10 border border-success/20 rounded-md px-3 py-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-3.5 w-3.5 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Password reset email sent! Check your inbox." })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								type: "submit",
								disabled: loading,
