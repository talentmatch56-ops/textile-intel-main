  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
        className:
          "font-mono text-sm tabular-nums text-foreground w-8 text-right",
        children: value,
      }),
    ],
  });
...
function renderValue(key, value) {
  ...
  if (key === "ai_risk_level")
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RiskBadge, {
      level: value,
    });
  if (
    [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScoreBar, { value });
      ...
      children: [
        value.slice(0, 4).map((v, i) =>
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              className:
                "text-[10px] px-1.5 py-0.5 rounded bg-muted border border-border font-mono",
              children: v,
            },
            i,
          ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        description:
          "Compare up to 3 textile companies side by side across trust scores, capacity, certifications and AI risk ratings.",
      }),
          ...
          selected.map(
            (c) =>
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                ...
                {
                  className:
                    "flex items-center gap-2 px-3 py-2 rounded-lg border border-primary/40 bg-primary/5",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [c.country_code, " · ", c.business_type],
                        }),
                      ],
                    }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "flex items-center gap-2 px-4 py-2 rounded-lg border border-dashed border-border text-muted-foreground hover:border-primary/50 hover:text-foreground transition-colors text-sm",
                  children: [
                ...
                showPicker &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "absolute top-full left-0 mt-1 w-72 rounded-lg border border-border bg-popover shadow-xl z-10",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                        ...
                        className:
                          "w-full h-9 px-3 rounded-t-lg border-b border-border bg-transparent text-sm outline-none",
                        autoFocus: true,
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          searchResults.map((c) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              "button",
                              {
                                ...
                                className:
                                  "w-full text-left px-3 py-2 text-sm hover:bg-muted/60 transition-colors border-b border-border/50 last:border-0",
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "div",
                                    {
      ...
      selected.length === 0 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "rounded-lg border border-border bg-card/50 p-16 text-center",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GitCompare, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children:
                "Add up to 3 companies using the button above to see a side-by-side comparison.",
            }),
          ],
        }),
      selected.length >= 2 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className: "p-4 bg-muted/30 border-r border-border",
                }),
                selected.map(
                  (c) =>
                    c &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      ...
                      {
                        className:
                          "p-4 border-r border-border last:border-0 bg-card",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "p-3 px-4 border-r border-border flex items-center",
                    ...
                    selected.map(
                      (c) =>
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          ...
                          {
                            className:
                              "p-3 px-4 border-r border-border last:border-0 flex items-center",
      ...
      selected.length === 1 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "p-6 rounded-lg border border-dashed border-border text-center text-sm text-muted-foreground",
          children:
