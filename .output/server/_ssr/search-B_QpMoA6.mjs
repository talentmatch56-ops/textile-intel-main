...
function Page() {
	...
	const { data } = useQuery({
		...
		queryFn: async () => {
			const [companies, countries] = await Promise.all([supabase.from("companies").select("id,name,country_code,city,business_type,ai_risk_level,ai_trust_score,certifications,moq,lead_time_days,employees_range,products"), supabase.from("countries").select("code,name")]);
			return {
	...
	const results = (0, import_react.useMemo)(() => {
		...
		let list = [...companies];
		if (activeQuery) list = list.filter((c) => c.name.toLowerCase().includes(activeQuery.toLowerCase()) || (c.city ?? "").toLowerCase().includes(activeQuery.toLowerCase()) || (c.business_type ?? "").toLowerCase().includes(activeQuery.toLowerCase()) || (c.products ?? []).some((p) => p.toLowerCase().includes(activeQuery.toLowerCase())));
	...
	const toggleCert = (cert) => setSelectedCerts((prev) => prev.includes(cert) ? prev.filter((c) => c !== cert) : [...prev, cert]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							value: query,
						...
						className: "shrink-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-4 w-4 mr-2" }), " Search"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[10px] font-mono uppercase tracking-widest text-muted-foreground w-20",
								children: "Type"
							}), TYPE_OPTIONS.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[10px] font-mono uppercase tracking-widest text-muted-foreground w-20",
								children: "Certs"
							}), CERT_OPTIONS.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			hasSearched && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						" results",
						activeQuery && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
							" for \"",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-10 w-10 text-muted-foreground mx-auto mb-3 opacity-40" }),
				...
				children: results.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-2",
									children: [i < 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "text-[10px] font-mono bg-primary/15 text-primary px-1.5 py-0.5 rounded",
										children: ["#", i + 1]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: (c.certifications ?? []).slice(0, 2).map((cert) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-[9px] font-mono px-1.5 py-0.5 rounded bg-success/10 text-success border border-success/20",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-2.5 w-2.5 inline mr-0.5" }), cert]
								}, cert))
							})]
						}),
						c.employees_range && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-2 text-[10px] text-muted-foreground font-mono flex items-center gap-1",
							children: [
			...
			!hasSearched && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-lg border border-border bg-card/50 p-12 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-12 w-12 text-primary/40 mx-auto mb-4" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Use natural language, product types, certifications, MOQ ranges, or countries to find the right textile partners."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
