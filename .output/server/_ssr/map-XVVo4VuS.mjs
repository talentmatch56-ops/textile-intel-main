...
var REGION_ORDER = ["Asia", "Europe", "Africa", "Americas"];
function Page() {
  const { data } = useQuery({
    queryKey: ["map-data"],
    queryFn: async () => {
      return (
        (await supabase.from("companies").select("country_code")).data ?? []
      );
    },
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        title: "World Map",
        description:
          "Geographic distribution of textile manufacturers, suppliers and brands across 40+ countries.",
      }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "text-[10px] font-mono uppercase tracking-widest text-muted-foreground mb-4 flex items-center gap-2",
                      children: [
                          ...
                          "div",
                          {
                            ...
                            children: [
                                ...
                                "div",
                                {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      ...
                                      {
                                        className:
                                          "font-mono leading-none opacity-70",
                                        style: {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                ...
                                {
                                  className:
                                    "text-[10px] font-mono text-muted-foreground text-center max-w-16 leading-tight",
                                  children: c.name,
                                },
                              ),
                            ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "px-4 py-2 border-t border-border bg-muted/20 flex items-center gap-4 text-[10px] font-mono text-muted-foreground",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "Bubble size = company count",
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "·",
              }),
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "span",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className: `h-2.5 w-2.5 rounded-full ${l.cls}`,
                        }),
                        l.label,
                      ],
                    },
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "text-[10px] font-mono text-muted-foreground w-5 text-right",
                          children: i + 1,
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className: "flex-1",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "w-24 h-1.5 bg-muted rounded-full overflow-hidden",
