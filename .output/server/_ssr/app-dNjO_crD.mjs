...
function AppSidebar() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
    className:
      "hidden md:flex w-60 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "h-14 flex items-center gap-2.5 px-4 border-b border-sidebar-border",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
            src: "/gmintel_logo.png",
            alt: "GMIntel Logo",
            className:
              "h-7 w-7 rounded-md object-cover border border-border/50",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "text-[10px] uppercase tracking-widest text-muted-foreground mt-0.5",
                children: "Textile · AI",
              }),
            ],
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "border-t border-sidebar-border px-3 py-3 text-[10px] font-mono text-muted-foreground",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "px-3 pb-1.5 text-[10px] uppercase tracking-widest text-muted-foreground/70 font-medium",
                    children: g.label,
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      ...
      isInstallable &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mx-2 mb-3 p-3 rounded-lg border border-border bg-muted/30 space-y-2",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "text-[9px] font-mono uppercase tracking-widest text-muted-foreground font-semibold",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              ...
              className:
                "w-full flex items-center justify-center gap-1.5 rounded bg-primary hover:bg-primary/95 text-primary-foreground py-1 px-2 text-xs font-semibold transition-all shadow shadow-primary/10 cursor-pointer",
              children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
    ...
    children: [
      ...
      item.badge &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
          className:
            "text-[9px] font-mono px-1.5 py-0.5 rounded bg-primary/15 text-primary font-semibold",
          children: item.badge,
        }),
    ],
  });
...
function AppTopbar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
    className:
      "h-14 border-b border-border bg-card/50 backdrop-blur flex items-center gap-3 px-4",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className: "md:hidden",
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
              side: "left",
              className:
                "w-60 p-0 flex flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "h-14 flex items-center gap-2.5 px-4 border-b border-sidebar-border",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "border-t border-sidebar-border px-3 py-3 text-[10px] font-mono text-muted-foreground mt-auto",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "flex-1 min-w-0 max-w-2xl flex items-center gap-2 h-9 px-3 rounded-md bg-muted/60 border border-border text-sm text-muted-foreground",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
            ...
            className:
              "w-full min-w-0 bg-transparent outline-none placeholder:text-muted-foreground text-foreground",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("kbd", {
            className:
              "hidden md:inline-flex items-center gap-1 text-[10px] font-mono px-1.5 py-0.5 rounded border border-border bg-background",
            children: [
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
              ...
              children: [
                ...
                unreadCount > 0 &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-primary animate-pulse",
                  }),
              ],
            }),
          }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                    ...
                    children: ["Announcements (", unreadCount, " unread)"],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "button",
                              {
                                onClick: clearAll,
                                className:
                                  "text-[10px] text-muted-foreground hover:underline",
                                children: "Clear",
                              },
                            ),
                          ],
                  ...
                  notifications.length === 0
                    ...
                    : notifications.map((n) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          ...
                          {
                            className:
                              "flex flex-col items-start gap-1 p-2 rounded cursor-pointer hover:bg-muted/50",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  className:
                                    "flex items-center justify-between w-full text-[10px]",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "span",
                                      {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppTopbar, {}),
