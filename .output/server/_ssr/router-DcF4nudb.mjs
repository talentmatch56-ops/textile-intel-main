  ...
  head: () => ({
    meta: [
      ...
      { title: "GMIntel AI — Global Textile Intelligence Platform" },
      {
        name: "description",
        content:
          "The Bloomberg of textiles. AI-powered intelligence on manufacturers, suppliers, brands, prices, and market trends across 40+ countries.",
      },
      {
        name: "author",
        content: "GMIntel",
      ...
      },
      {
        ...
        content:
          "AI-powered discovery, sourcing, risk and market intelligence for the global textile and apparel industry.",
      },
      {
        property: "og:type",
        content: "website",
