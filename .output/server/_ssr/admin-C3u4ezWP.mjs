...
import { G as Building2, R as Clock, U as ChevronDown, V as ChevronUp, a as Users, ct as CircleX, d as ShieldCheck, l as Trash2, n as X, nt as OctagonAlert, ot as EllipsisVertical, tt as PenLine, ut as CircleCheck, v as Plus, z as ClipboardList } from "../_libs/lucide-react.mjs";
...
function Page() {
	...
	const [formBusinessType, setFormBusinessType] = (0, import_react.useState)("manufacturer");
	...
	const [formStatus, setFormStatus] = (0, import_react.useState)("pending_review");
	const { data: queryData, refetch: refetchCompanies } = useQuery({
		queryKey: ["admin-companies"],
		queryFn: async () => {
			const [compRes, countRes] = await Promise.all([supabase.from("companies").select("id,slug,name,country_code,city,business_type,status,ai_risk_level,ai_trust_score,monthly_capacity,moq,lead_time_days,created_at").order("created_at", { ascending: false }), supabase.from("countries").select("code,name").order("name")]);
			return {
	...
	const handleDeleteCompany = async (id, name) => {
		if (window.confirm(`Are you sure you want to permanently delete "${name}"?`)) try {
		...
		children: [
			...
			activeTab === "companies" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col sm:flex-row sm:items-center justify-between p-4 border-b border-border gap-3 bg-muted/10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-3.5 w-3.5" }), " Add Company"]
						})]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [action && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EllipsisVertical, { className: "h-4 w-4 text-muted-foreground" })
												})
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PenLine, { className: "h-3.5 w-3.5" }), " Edit Details"]
													}),
													action && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
														onClick: () => updateStatus(c.id, action.nextStatus),
													...
													c.status !== "rejected" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-3.5 w-3.5" }), " Delete Company"]
													})
												]
											})] })]
										})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "sm:max-w-xl max-h-[90vh] overflow-y-auto bg-card border border-border p-6 font-sans",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
						className: "font-display text-lg font-bold text-foreground",
						children: isEditing ? "Edit Company Registry Profile" : "Add New Verified Company"
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
										...
										children: countries.map((cnt) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
											value: cnt.code,
											children: [
												cnt.name,
												" (",
