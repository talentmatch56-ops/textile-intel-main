...
function Page() {
  ...
  const filtered = (0, import_react.useMemo)(
    () =>
      statusFilter === "all"
        ? pipeline
        : pipeline.filter((c) => c.status === statusFilter),
  ...
  const stats = (0, import_react.useMemo)(
    () => ({
      ...
      rate: Math.round(
        (pipeline.filter((c) => c.status === "verified").length /
          Math.max(pipeline.length, 1)) *
          100,
      ),
    }),
    [pipeline],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        description:
          "GMIntel's AI continuously crawls trade portals, government databases, B2B platforms and web sources to discover and verify new textile businesses.",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children: ["all", "pending_review", "verified"].map((s) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "col-span-2 text-xs text-muted-foreground capitalize",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "col-span-1 text-right font-mono tabular-nums text-foreground",
