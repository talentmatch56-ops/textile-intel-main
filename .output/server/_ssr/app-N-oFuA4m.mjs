...
function Dashboard() {
  ...
  const [briefingLoading, setBriefingLoading] = (0, import_react.useState)(
    false,
  );
  const [mounted, setMounted] = (0, import_react.useState)(false);
  const [briefingTitle, setBriefingTitle] = (0, import_react.useState)(
    BRIEFING_CONTENT.title,
  );
  const [briefingDate, setBriefingDate] = (0, import_react.useState)(
  ...
  (0, import_react.useMemo)(() => {
    if (typeof window !== "undefined") {
      ...
      BRIEFING_CONTENT.title = `GMIntel AI Briefing — ${d.toLocaleDateString(
        "en-US",
        {
          month: "long",
          year: "numeric",
  ...
  (0, import_react.useState)(() => {
    if (typeof window !== "undefined") {
      const d = /* @__PURE__ */ new Date();
      setBriefingTitle(
        `GMIntel AI Briefing — ${d.toLocaleDateString("en-US", {
          month: "long",
          year: "numeric",
        })}`,
      );
  ...
  const dbCompanies = (0, import_react.useMemo)(() => {
    ...
    if (data.companies && Array.isArray(data.companies.data))
  ...
  const countryMap = (0, import_react.useMemo)(
  ...
  companies.filter((c) => c.created_at && new Date(c.created_at) >= today)
    .length;
  const byCountry = {};
  companies.forEach((c) => {
    if (c.country_code)
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        description:
          "Real-time market, supplier and risk signals across the world's textile hubs.",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
            ...
            icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Factory, {
              className: "h-4 w-4",
            }),
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "lg:col-span-2 rounded-lg border border-border bg-card p-5",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      AreaChart,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", {
                            children: /* @__PURE__ */ (0,
                            import_jsx_runtime.jsxs)("linearGradient", {
                              id: "g1",
                              x1: "0",
                              y1: "0",
                              x2: "0",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "lg:col-span-2 rounded-lg border border-border bg-card overflow-hidden",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                    ...
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, {
                            className:
                              "h-8 w-8 text-muted-foreground/45 mx-auto mb-2",
                          }),
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            ...
                            children:
                              "Start tracking suppliers on the Companies tab to see their latest announcements here.",
                          }),
                        ],
                      })
                    : watchlistedData.map((c) => {
                        ...
                        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          "div",
                          {
                            ...
                            className:
                              "p-4 hover:bg-muted/30 transition-colors cursor-pointer flex items-start justify-between gap-4",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  ...
                                  children: [
                                    ...
                                    import_jsx_runtime.jsxs)("div", {
                                      ...
                                      children: [
                                        ...
                                        import_jsx_runtime.jsx)("span", {
                                          className:
                                            "font-semibold text-foreground hover:text-primary transition-colors text-sm truncate",
                                          children: c.name,
                                        }),
                                        /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsxs)(Badge, {
                                          variant: "outline",
                                          className:
                                            "text-[9px] font-mono tracking-wide py-0 px-1 border-0 bg-primary/10 text-primary",
                                          children: [
                                            "Trust ",
                                            c.ai_trust_score,
                                          ],
                                        ...
                                        /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsx)(RiskBadge, {
                                    ...
                                    latestCompanyNews
                                      ? /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsxs)("div", {
                                          className:
                                            "space-y-0.5 pl-3 border-l border-border/80",
                                          children: [
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)("div", {
                                              className:
                                                "text-[10px] font-semibold text-foreground/80 leading-normal truncate",
                                      ...
                                      : /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsx)("p", {
                                          className:
                                            "text-xs text-muted-foreground/75 italic pl-3",
                                          children:
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "button",
                                {
                                  ...
                                  className:
                                    "p-1 hover:bg-muted rounded text-primary",
                                  children: /* @__PURE__ */ (0,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "divide-y divide-border max-h-[350px] overflow-y-auto",
                children: combinedCompanyNews.slice(0, 6).map((n) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      onClick: () => {
                        const comp = companies.find(
                          (c) => c.slug === n.company_slug,
                        );
                        if (comp) {
                      ...
                      className:
                        "p-4 hover:bg-muted/40 transition-colors cursor-pointer space-y-1.5",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "text-xs font-semibold text-foreground leading-snug line-clamp-2",
                          children: n.title,
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "text-[10px] text-muted-foreground flex justify-between font-mono",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              "span",
                              { children: ["Source: ", n.source] },
                            ),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "span",
                              {
        ...
        children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "hidden sm:block col-span-2 font-mono text-xs text-muted-foreground",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "col-span-3 sm:col-span-2 text-right font-mono tabular-nums text-foreground",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className: "divide-y divide-border",
                children: (news.length > 0 ? news : MOCK_NEWS_ITEMS).map((n) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "text-[10px] font-mono uppercase text-muted-foreground flex items-center justify-between",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "span",
                              { children: n.category ?? "News" },
                            ),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "span",
                              {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "rounded-lg border border-primary/30 bg-gradient-to-br from-primary/[0.06] to-transparent p-5",
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className: "flex items-start gap-3",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "h-8 w-8 rounded-md bg-primary/15 border border-primary/30 flex items-center justify-center text-primary shrink-0",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  ...
                  children:
                    "Trailing 30-day price action shows firming demand out of Bangladesh and India, with new capacity announcements offsetting soft PMI prints in Turkey. Consider locking Q1 volumes with tier-1 GOTS-certified mills.",
                }),
              ],
            }),
          ],
      ...
      briefingOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "relative w-full max-w-2xl rounded-lg border border-border bg-card shadow-lg p-6 max-h-[85vh] flex flex-col animate-in fade-in zoom-in-95 duration-150",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                onClick: () => setBriefingOpen(false),
                className:
                  "absolute right-4 top-4 text-muted-foreground hover:text-foreground p-1 rounded hover:bg-muted transition-colors cursor-pointer",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "text-[10px] font-mono text-muted-foreground mb-4 uppercase tracking-widest border-b border-border pb-2",
                children: [
                  "Compiled on ",
                  briefingDate,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex-1 overflow-y-auto space-y-4 pr-1 text-sm text-muted-foreground leading-relaxed",
                children: BRIEFING_CONTENT.sections.map((sec, idx) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                              ...
                              "div",
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    ...
                                    {
                                      className:
                                        "h-5 w-5 text-muted-foreground/65 mx-auto mb-1.5",
                                    },
                                  ),
