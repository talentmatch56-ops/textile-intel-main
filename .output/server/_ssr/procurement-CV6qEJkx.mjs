...
function Page() {
  ...
  const toggleCert = (cert) =>
    setForm((f) => ({
      ...f,
      certs: f.certs.includes(cert)
        ? f.certs.filter((c) => c !== cert)
        : [...f.certs, cert],
    }));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        description:
          "Submit RFQs and let AI match you with ranked, verified suppliers based on your requirements.",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
                      className:
                        "block text-xs font-mono uppercase tracking-wider text-muted-foreground mb-1",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      ...
                      className:
                        "w-full h-9 px-3 rounded border border-border bg-card text-sm outline-none focus:border-primary",
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                          ...
                          className:
                            "w-full h-9 px-2 rounded border border-border bg-card text-sm outline-none focus:border-primary",
                          children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
                      className:
                        "block text-xs font-mono uppercase tracking-wider text-muted-foreground mb-1",
                      children: ["Target Price (USD/", form.unit, ")"],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
                      className:
                        "block text-xs font-mono uppercase tracking-wider text-muted-foreground mb-2",
                      children: "Required Certifications",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: "flex flex-wrap gap-2",
                      children: CERT_OPTIONS.map((c) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "button",
                          {
                            type: "button",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
                      ...
                      placeholder:
                        "Colour preferences, packaging, sample requirements…",
                      rows: 3,
                      className:
                        "w-full px-3 py-2 rounded border border-border bg-card text-sm outline-none focus:border-primary resize-none",
                    }),
                  ],
                }),
              ],
                ...
                "div",
                {
                  children: [
                    ...
                    expandedRfq === rfq.id &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "px-4 pb-4 border-t border-border/50 bg-muted/20",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                                        ...
                                        import_jsx_runtime.jsxs)("div", {
                                          ...
                                          children: [
                                            ...
                                            import_jsx_runtime.jsxs)("span", {
                                              className:
                                                "text-[10px] font-mono bg-primary/15 text-primary px-1 rounded",
                                              children: ["#", i + 1],
                                            }),
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)("span", {
