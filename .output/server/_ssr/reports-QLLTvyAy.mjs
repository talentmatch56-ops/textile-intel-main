  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
        ...
        title: "AI Reports",
        description:
          "Generate one-click intelligence reports on suppliers, countries, markets, pricing, trends and competitors.",
      }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "text-[10px] font-mono uppercase tracking-widest text-primary mb-3",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: REPORT_TYPES.map((rt) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                ...
                {
                  className:
                    "rounded-lg border border-border bg-card p-5 hover:border-primary/40 transition-colors group",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            generating === rt.kind
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                  import_jsx_runtime.Fragment,
                                  {
                                    children: [
                                      /* @__PURE__ */ (0,
                                      import_jsx_runtime.jsx)(LoaderCircle, {
            ...
            children: [
              ...
              reports.length === 0 &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children:
                    "No reports generated yet. Use the library above to create your first report.",
                }),
              reports.map((r) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "hidden sm:block col-span-2 text-xs text-muted-foreground capitalize",
                        ...
                        children:
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                              ...
                              className:
                                "text-muted-foreground hover:text-primary transition-colors p-1 rounded hover:bg-muted",
                              title: "Download",
                              children: /* @__PURE__ */ (0,
                              import_jsx_runtime.jsx)(Download, {
                                className: "h-4 w-4",
                              }),
                            },
                          ),
