    ...
    children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "h-7 w-7 rounded-md bg-primary flex items-center justify-center font-mono text-primary-foreground text-sm font-bold",
                  children: "GM",
                }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "flex gap-8 py-2 px-6 whitespace-nowrap animate-scroll font-mono text-xs",
          children: [...TICKER, ...TICKER].map((t, i) =>
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "absolute inset-0 ticker-grid opacity-[0.05] pointer-events-none",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-3 py-1 text-[10px] font-mono uppercase tracking-widest text-primary",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
                        className:
                          "mt-6 font-display text-5xl md:text-6xl font-bold tracking-tight leading-tight",
                        children: [
                          "The ",
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className: "text-primary",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        ...
                        children:
                          "GMIntel AI discovers, verifies, and analyzes manufacturers, suppliers, brands, prices, and market signals across 40+ textile hubs — surfaced through a real-time terminal and an AI sourcing copilot.",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "mt-8 flex flex-wrap gap-4 text-xs text-muted-foreground font-mono",
                        children: [
                          "SOC-2 Ready",
                          "RBAC Access Control",
                          "Public Data Only",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      ...
                      {
                        className:
                          "rounded-xl border border-border bg-card overflow-hidden shadow-2xl glow-primary",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                ...
                                {
                                  className:
                                    "h-3 w-3 rounded-full bg-destructive/60",
                                },
                              ),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                                  className:
                                    "h-3 w-3 rounded-full bg-warning/60",
                                },
                              ),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                                  className:
                                    "h-3 w-3 rounded-full bg-success/60",
                                },
                              ),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                                  className:
                                    "ml-3 text-[11px] font-mono text-muted-foreground",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                ...
                                {
                                  className:
                                    "ml-auto flex items-center gap-1.5 text-[10px] font-mono text-success",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "span",
                                      {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                ...
                                {
                                  className:
                                    "space-y-2 pl-3 border-l border-primary/30",
                                  children: [
                                    {
                                    ...
                                    import_jsx_runtime.jsxs)(
                                      ...
                                      {
                                        className:
                                          "flex items-center justify-between gap-3 py-1.5 border-b border-border/50 last:border-0",
                                        children: [
                                          /* @__PURE__ */ (0,
                                          import_jsx_runtime.jsxs)("div", {
                                            children: [
                                              ...
                                              import_jsx_runtime.jsxs)("div", {
                                                className:
                                                  "text-muted-foreground text-[10px] mt-0.5",
                                                children: [
                                                  r.country,
                                                  " · ",
                                                  r.cert,
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "px-5 py-3 border-t border-border bg-muted/20 flex items-center justify-between",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "div",
                                {
                                  ...
                                  children:
                                    "4 results · AI-ranked by trust score",
                                },
                              ),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "div",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "mt-2 font-display text-3xl font-bold text-primary",
                          children: s.v,
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
              className:
                "mt-2 font-display text-3xl md:text-4xl font-bold max-w-2xl",
              children: "Twelve modules. One intelligence layer.",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              className: "mt-3 text-muted-foreground max-w-2xl",
              children:
                "Every tool in GMIntel connects to the same live data engine — no silos, no switching tabs.",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: FEATURES.map((f) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    className:
                      "rounded-lg border border-border bg-card p-5 hover:border-primary/50 hover:bg-primary/[0.02] transition-all group",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "h-9 w-9 rounded-md bg-primary/10 border border-primary/20 flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-colors",
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              className: "mt-3 text-muted-foreground max-w-2xl",
              children:
                "Every signal on GMIntel is sourced from public trade data, verified registries, and licensed market feeds — then enriched by AI.",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "mt-10 grid md:grid-cols-2 gap-6",
              children: INTEL_SIGNALS.map((s) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    className:
                      "flex gap-4 p-5 rounded-lg border border-border bg-card hover:border-primary/30 transition-colors",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "h-9 w-9 rounded-md bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0",
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          Zap,
                          { className: "h-4 w-4 text-primary" },
                        ),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-8 p-4 rounded-lg border border-border bg-muted/20 flex items-start gap-3",
              children: [
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              className: "mt-3 text-muted-foreground max-w-2xl",
              children:
                "From Dhaka to Guangdong, Izmir to Ludhiana — GMIntel covers the world's entire textile supply chain geography.",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "mt-10 space-y-3",
              children: COVERAGE_HUBS.map((h) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    className:
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "shrink-0 text-sm font-mono font-semibold text-primary",
                        children: [h.pct, "%"],
                      }),
                    ],
                  },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex flex-wrap items-start justify-between gap-8 mb-8",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "font-mono text-[10px] uppercase tracking-widest text-muted-foreground mb-3",
                          children: "Platform",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-border text-xs text-muted-foreground font-mono",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    "© ",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  children:
                    "Public data · Licensed feeds · AI insights clearly labeled",
                }),
              ],
            }),
          ],
