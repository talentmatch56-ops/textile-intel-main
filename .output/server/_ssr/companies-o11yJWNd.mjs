...
import { n as MOCK_COMPANY_NEWS, t as Badge } from "./mock-company-news-BDbtL397.mjs";
...
function Page() {
	...
	const activeCompanyNews = (0, import_react.useMemo)(() => {
		...
		return [...storedNews ? JSON.parse(storedNews) : [], ...MOCK_COMPANY_NEWS].filter((n) => n.company_slug === selectedCompany.slug).sort((a, b) => new Date(b.published_at).getTime() - new Date(a.published_at).getTime());
	}, [selectedCompany]);
	const aiSummary = (0, import_react.useMemo)(() => {
		if (!selectedCompany) return "";
		if (activeCompanyNews.length === 0) return `${selectedCompany.name} is currently showing stable operational activity with no risk alerts. Sourcing metrics are verified and supply reliability index is high.`;
		...
		if (negative > 0) summaryText += `Minor headwinds noted (such as raw material shortages or shipping delays), but capacity and quality structures remain resilient.`;
		else summaryText += `Strong progress is driven by active circular/sustainability initiatives and expanded manufacturing capabilities.`;
		return summaryText;
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: cn("h-4 w-4 transition-transform hover:scale-110", isFollowed ? "fill-primary text-primary" : "text-muted-foreground") })
											})
										})
									]
								}, c.id);
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: activeCompanyNews.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-5 w-5 text-muted-foreground/60 mx-auto mb-1.5" }), "No recent updates reported for this supplier."]
