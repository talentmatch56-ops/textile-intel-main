...
function renderMarkdown(text) {
  if (text.includes("```text"))
    return text.split("```text").map((part, i) => {
      if (i % 2 === 1) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            className:
              "my-2 p-3 bg-muted/60 border border-border rounded font-mono text-xs overflow-x-auto whitespace-pre text-foreground",
                ...
                : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      msg.isStreaming &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          className:
                            "inline-block h-3.5 w-1.5 ml-0.5 bg-primary animate-pulse",
                        }),
                    ],
                  }),
              !isUser &&
...
function Page() {
  ...
  const send = () => {
    ...
    const lastAssistantContent = [...currentMessages]
      .reverse()
      .find((m) => m.role === "assistant")?.content;
    setTimeout(() => {
      setThinking(false);
      streamAIResponse(
        getAIResponse(text, companies, countries, news, lastAssistantContent),
      );
    }, 1200);
  };
  const newThread = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "px-6 md:px-8 pt-6 md:pt-8 pb-4 border-b border-border flex-none",
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
          eyebrow: "Command Center · AI",
          title: "AI Assistant",
          description:
            "Your GMIntel sourcing copilot. Ask about suppliers, prices, risks, and market trends.",
        }),
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
            className:
              "hidden md:flex w-64 flex-col border-r border-border bg-card/30",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "button",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "text-[10px] font-mono text-muted-foreground/60 mt-0.5 pl-5",
            ...
            children: [
                  ...
                  thinking &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "h-7 w-7 rounded-md bg-muted border border-border flex items-center justify-center shrink-0",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          className:
                            "bg-card border border-border rounded-lg px-4 py-3 flex items-center gap-2 text-sm text-muted-foreground shadow-sm",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              LoaderCircle,
                              {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "button",
                          {
                            ...
                            className:
                              "text-[11px] font-mono px-2.5 py-1 rounded-full border border-border text-muted-foreground hover:border-primary/50 hover:text-primary transition-colors",
                            children: prompt,
                          },
                          prompt,
                        ),
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            ...
                            {
                              className:
                                "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary/60",
                            },
                          ),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "mt-2 text-[10px] font-mono text-muted-foreground text-center",
                    children:
