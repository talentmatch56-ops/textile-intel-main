...
var y = class extends s {
  ...
  #g() {
    ...
    if (p.isServer() || this.#r.isStale || !f(e)) return;
    let t = _(this.#r.dataUpdatedAt, e) + 1;
    this.#d = r.setTimeout(() => {
  ...
  #b() {
    this.#d !== void 0 && (r.clearTimeout(this.#d), (this.#d = void 0));
  }
  #x() {
    this.#f !== void 0 && (r.clearInterval(this.#f), (this.#f = void 0));
  }
  createResult(e, t) {
    let n = this.#t,
      r = this.options,
    ...
    if (t._optimisticResults) {
      let i = this.hasListeners(),
        a = !i && x(e, t),
        s = i && C(e, n, t, r);
      ((a || s) && (p = { ...p, ...o(f.data, e.options) }),
        t._optimisticResults === `isRestoring` && (p.fetchStatus = `idle`));
    }
    let { error: g, errorUpdatedAt: _, status: v } = p;
    h = p.data;
    let y = !1;
      ...
      (a?.isPlaceholderData && t.placeholderData === c?.placeholderData
        ...
        : (e =
            typeof t.placeholderData == `function`
              ...
              : t.placeholderData),
        e !== void 0 && ((v = `success`), (h = l(a?.data, e, t)), (m = !0)));
    }
    if (t.select && h !== void 0 && !y)
      if (a && h === s?.data && t.select === this.#c) h = this.#l;
      else
        try {
          ((this.#c = t.select),
            (h = t.select(h)),
    ...
    this.#s && ((g = this.#s), (h = this.#l), (_ = Date.now()), (v = `error`));
    let b = p.fetchStatus === `fetching`,
      S = v === `pending`,
      T = v === `error`,
      E = S && b,
      D = h !== void 0,
...
function S(e, t, n) {
  if (i(t.enabled, e) !== !1 && g(t.staleTime, e) !== `static`) {
...
function w(e, t) {
  return i(t.enabled, e) !== !1 && e.isStaleByTime(g(t.staleTime, e));
}
function T(e, t) {
  return !v(e.getCurrentResult(), t);
}
var E = e(t(), 1);
n();
function D() {
...
var O = E.createContext(D()),
  k = () => E.useContext(O),
  A = (e, t, n) => {
    let r =
      n?.state.error && typeof e.throwOnError == `function`
        ? a(e.throwOnError, [n.state.error, n])
        : e.throwOnError;
...
function z(e, t, n) {
  ...
  let d = !a.getQueryCache().get(o.queryHash),
    [f] = E.useState(() => new t(a, o)),
    h = f.getOptimisticResult(o),
    g = !r && l;
  if (
    (E.useSyncExternalStore(
      E.useCallback(
        (e) => {
          let t = g ? f.subscribe(c.batchCalls(e)) : u;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !p.isServer() &&
      I(h, r) &&
      (d ? R(o, f, i) : s?.promise)?.catch(u).finally(() => {
        f.updateResult();
      }),
    o.notifyOnChangeProps ? h : f.trackResult(h)
  );
}
function B(e, t) {
  return z(e, y, t);
