...
import { t as s } from "./arrow-up-down-meuA2MCD.js";
import { t as c } from "./shield-alert-9Y_5-gpD.js";
import { t as l } from "./trending-down-CVd78YMv.js";
import { t as u } from "./page-header-KBYaDscd.js";
import { t as d } from "./risk-badge-3U59-BfT.js";
import {
  O as f,
  P as p,
  a as m,
...
function w() {
  let [e, t] = (0, x.useState)(`ai_risk_score`),
    [n, a] = (0, x.useState)(!1),
    [w, T] = (0, x.useState)(`all`),
    { data: E, isLoading: D } = r({
    ...
    O = E?.companies ?? [],
    k = Object.fromEntries((E?.countries ?? []).map((e) => [e.code, e.name])),
    A = (0, x.useMemo)(
      () => ({
        total: O.length,
        high: O.filter((e) => e.ai_risk_level === `high`).length,
        medium: O.filter((e) => e.ai_risk_level === `medium`).length,
        low: O.filter((e) => e.ai_risk_level === `low`).length,
      }),
      [O],
    ),
    j = (0, x.useMemo)(() => {
      ...
      return (
        O.forEach((t) => {
          let n = t.country_code ?? `??`;
          (e[n] || (e[n] = { high: 0, medium: 0, low: 0 }),
        ...
        Object.entries(e)
          .map(([e, t]) => ({
            name: k[e] ?? e,
            ...t,
            total: t.high + t.medium + t.low,
          }))
          .sort((e, t) => t.high - e.high)
          .slice(0, 8)
      );
    }, [O, k]),
    M = (0, x.useMemo)(() => {
      let t = [...O];
      return (
        w !== `all` && (t = t.filter((e) => e.ai_risk_level === w)),
        t.sort((t, r) => {
          let i = t[e],
            a = r[e];
          return n ? (i > a ? 1 : -1) : i < a ? 1 : -1;
        }),
        t
      );
    }, [O, w, e, n]),
      ...
      (0, S.jsxs)(`div`, {
        ...
        children: [
          (0, S.jsx)(o, {
            ...
            value: A.total,
            icon: (0, S.jsx)(c, { className: `h-4 w-4` }),
          }),
          (0, S.jsx)(o, {
            label: `High Risk`,
            value: A.high,
            delta: {
              value: `${Math.round((A.high / Math.max(A.total, 1)) * 100)}%`,
              positive: !1,
            },
            icon: (0, S.jsx)(b, { className: `h-4 w-4` }),
          }),
          (0, S.jsx)(o, {
            label: `Medium Risk`,
            value: A.medium,
            icon: (0, S.jsx)(l, { className: `h-4 w-4` }),
          }),
          (0, S.jsx)(o, {
            label: `Low Risk`,
            value: A.low,
            delta: { value: `verified safe`, positive: !0 },
            icon: (0, S.jsx)(y, { className: `h-4 w-4` }),
          }),
        ],
      }),
      (0, S.jsxs)(`div`, {
          ...
          (0, S.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, S.jsx)(`div`, {
                ...
                children: [`all`, `high`, `medium`, `low`].map((e) =>
                  (0, S.jsx)(
                    `button`,
                    {
                      onClick: () => T(e),
                      className: `px-2.5 py-1 rounded text-xs font-mono border capitalize transition-colors ${w === e ? `bg-primary/15 text-primary border-primary/40` : `border-border text-muted-foreground hover:border-primary/30`}`,
                      children: e,
                    },
                    e,
                  ),
                  ...
                  `div`,
                  {
                    ...
                    children: [
                      ...
                      (0, S.jsx)(`div`, {
                        ...
                        children: k[e.country_code ?? ``] ?? e.country_code,
                      }),
                      (0, S.jsx)(`div`, {
                        className: `col-span-2 text-right`,
                        children: (0, S.jsx)(`span`, {
                          className: `font-mono tabular-nums font-semibold ${(e.ai_risk_score ?? 50) >= 70 ? `text-destructive` : (e.ai_risk_score ?? 50) >= 40 ? `text-warning` : `text-success`}`,
                          children: e.ai_risk_score ?? `—`,
                        }),
                      }),
                      (0, S.jsx)(`div`, {
                      ...
                      (0, S.jsx)(`div`, {
                        ...
                        children: e.ai_sustainability_score ?? `—`,
                      }),
                      (0, S.jsx)(`div`, {
                        className: `col-span-1 text-right`,
                        children: (0, S.jsx)(d, { level: e.ai_risk_level }),
                      }),
                    ],
                  },
                  e.id,
