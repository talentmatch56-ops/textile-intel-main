...
import { t as n } from "./react-dom-CQmWuZA8.js";
var r = e(t(), 1);
n();
function i(e) {
  ...
  o = new (class {
    constructor() {
      ((this.subscribe = (e) => (
        ...
        (this.create = (e) => {
          let { message: t, ...n } = e,
            r = typeof e?.id == `number` || e.id?.length > 0 ? e.id : a++,
        ...
        (this.promise = (e, t) => {
          ...
          let i = Promise.resolve(e instanceof Function ? e() : e),
                  ...
                  let i =
                    ...
                    o =
                      typeof t.description == `function`
                        ...
                        : t.description,
                    s =
                      typeof i == `object` && !r.isValidElement(i)
                        ? i
                        : { message: i };
                  this.create({ id: n, type: `error`, description: o, ...s });
                  ...
                  let i =
                    ...
                    s =
                      typeof i == `object` && !r.isValidElement(i)
                        ? i
                        : { message: i };
                  this.create({ id: n, type: `success`, description: o, ...s });
                }
              })
              .catch(async (e) => {
            ...
            l = () =>
              new Promise((e, t) =>
                s.then(() => (o[0] === `reject` ? t(o[1]) : e(o[1]))).catch(t),
              );
