...
import { t as u } from "./arrow-up-down-meuA2MCD.js";
import { t as d } from "./building-2-CXtiLEWT.js";
import { t as f } from "./search-Cr1alROc.js";
import { i as p, r as m, t as h } from "./mock-company-news-DAcH1U7z.js";
import { t as g } from "./users-CMoH1Sms.js";
import { t as _ } from "./button-CoQ0AAlw.js";
import { a as ee, i as te, n as v, r as y, t as b } from "./sheet-RFeW-6F5.js";
import { t as x } from "./page-header-KBYaDscd.js";
import { t as S } from "./risk-badge-3U59-BfT.js";
import { t as C } from "./dist-ByBcCr1c.js";
import { t as ne } from "./mock-companies-DOsMh2YD.js";
var w = a(`funnel`, [
    [
      `path`,
      {
...
function O() {
  let [e, t] = (0, E.useState)(``),
    ...
    [O, k] = (0, E.useState)(``),
    [A, j] = (0, E.useState)(``),
    [M, re] = (0, E.useState)(`name`),
    [N, P] = (0, E.useState)(!0),
    [F, I] = (0, E.useState)([]),
    [L, R] = (0, E.useState)(null),
    [z, B] = (0, E.useState)(!1);
  (0, E.useEffect)(() => {
    if (typeof window < `u`) {
  ...
  let V = (e, t) => {
    ...
    { data: H, isLoading: U } = r({
      queryKey: [`companies`],
      queryFn: async () => {
        let [e, t] = await Promise.all([
          i.from(`companies`).select(`*`).order(`name`),
          i.from(`countries`).select(`code,name`),
        ]);
        return { companies: e.data ?? [], countries: t.data ?? [] };
      },
    }),
    W = H?.companies ?? [],
    G = (0, E.useMemo)(() => {
    ...
    K = H?.countries ?? [],
    q = Object.fromEntries(K.map((e) => [e.code, e.name])),
    J = (0, E.useMemo)(
      () => [...new Set(G.map((e) => e.business_type).filter(Boolean))].sort(),
      [G],
    ),
    Y = (0, E.useMemo)(
      () => [...new Set(G.map((e) => e.country_code).filter(Boolean))].sort(),
      [G],
    ),
    X = (0, E.useMemo)(() => {
      let t = [...G];
        ...
        e &&
          (t = t.filter(
            (t) =>
              ...
              (t.city ?? ``).toLowerCase().includes(e.toLowerCase()),
          )),
        n && (t = t.filter((e) => e.country_code === n)),
        O &&
          (t = t.filter((e) =>
            (e.business_type ?? ``).toLowerCase().includes(O.toLowerCase()),
          )),
        A && (t = t.filter((e) => e.ai_risk_level === A)),
        t.sort((e, t) => {
          let n = e[M],
            r = t[M],
            i = n ?? ``,
    ...
    Z = (0, E.useMemo)(
      () => ({
        total: G.length,
        verified: G.filter((e) => e.status === `verified`).length,
        highRisk: G.filter((e) => e.ai_risk_level === `high`).length,
        avgTrust:
          G.length > 0
            ? Math.round(
                G.reduce((e, t) => e + (t.ai_trust_score ?? 0), 0) / G.length,
              )
            : 0,
      }),
      [G],
    ...
    $ = (0, E.useMemo)(() => {
      ...
      let e =
        typeof window < `u`
          ...
          : null;
      return [...(e ? JSON.parse(e) : []), ...h]
        .filter((e) => e.company_slug === L.slug)
        .sort(
          (e, t) =>
    ...
    ie = (0, E.useMemo)(() => {
      if (!L) return ``;
      if ($.length === 0)
        return `${L.name} is currently showing stable operational activity with no risk alerts. Sourcing metrics are verified and supply reliability index is high.`;
      let e = $.filter((e) => e.sentiment === `positive`).length,
        t = $.filter((e) => e.sentiment === `negative`).length,
        n = $[0],
        r = `AI analysis highlights a predominantly ${e >= t ? `positive` : `cautious`} market trajectory. `;
      return (
        (r += `Key event: "${n.title}" (${n.category.replace(`_`, ` `)}). `),
        t > 0
          ? (r += `Minor headwinds noted (such as raw material shortages or shipping delays), but capacity and quality structures remain resilient.`)
          : (r += `Strong progress is driven by active circular/sustainability initiatives and expanded manufacturing capabilities.`),
        r
      );
    }, [L, $]);
  return (0, D.jsxs)(`div`, {
      ...
      (0, D.jsxs)(`div`, {
        ...
        children: [
          (0, D.jsx)(l, {
            ...
            value: Z.total.toLocaleString(),
            icon: (0, D.jsx)(d, { className: `h-4 w-4` }),
          }),
          (0, D.jsx)(l, {
            label: `Verified`,
            value: Z.verified.toLocaleString(),
            delta: { value: `AI-scored`, positive: !0 },
            icon: (0, D.jsx)(g, { className: `h-4 w-4` }),
          }),
          (0, D.jsx)(l, {
            label: `High Risk`,
            value: Z.highRisk,
            delta: {
              value: `${Math.round((Z.highRisk / Math.max(Z.total, 1)) * 100)}%`,
              positive: !1,
            },
          }),
          (0, D.jsx)(l, {
      ...
      (0, D.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, D.jsxs)(`select`, {
            ...
            children: [
              (0, D.jsx)(`option`, { value: ``, children: `All Countries` }),
              Y.map((e) =>
                (0, D.jsx)(`option`, { value: e, children: q[e] ?? e }, e),
              ),
            ],
          }),
          (0, D.jsxs)(`select`, {
            ...
            className: `h-9 px-3 rounded-md border border-border bg-card text-sm text-foreground outline-none focus:border-primary`,
            children: [
              (0, D.jsx)(`option`, { value: ``, children: `All Types` }),
              J.map((e) => (0, D.jsx)(`option`, { value: e, children: e }, e)),
            ],
          }),
          (0, D.jsxs)(`select`, {
            value: A,
            ...
            className: `h-9 px-3 rounded-md border border-border bg-card text-sm text-foreground outline-none focus:border-primary`,
            children: [
              (0, D.jsx)(`option`, { value: ``, children: `All Risk Levels` }),
              (0, D.jsx)(`option`, { value: `low`, children: `Low` }),
              (0, D.jsx)(`option`, { value: `medium`, children: `Medium` }),
              (0, D.jsx)(`option`, { value: `high`, children: `High` }),
            ],
          }),
          (e || n || O || A) &&
            (0, D.jsxs)(_, {
              ...
              children: [
                (0, D.jsx)(w, { className: `h-3.5 w-3.5 mr-1` }),
                ` Clear`,
              ],
            }),
        ],
      ...
      (0, D.jsxs)(`div`, {
        ...
        children: [
          (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsxs)(`button`, {
                ...
                onClick: () => Q(`name`),
                children: [`Company `, (0, D.jsx)(u, { className: `h-3 w-3` })],
              }),
              (0, D.jsxs)(`button`, {
                className: `hidden sm:flex col-span-2 items-center gap-1 hover:text-foreground`,
                onClick: () => Q(`country_code`),
                children: [`Country `, (0, D.jsx)(u, { className: `h-3 w-3` })],
              }),
              (0, D.jsx)(`div`, {
              ...
              (0, D.jsxs)(`button`, {
                ...
                onClick: () => Q(`ai_trust_score`),
                children: [`Trust `, (0, D.jsx)(u, { className: `h-3 w-3` })],
              }),
              (0, D.jsx)(`div`, {
                    ...
                    children: [
                      (0, D.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, D.jsxs)(`div`, {
                            ...
                            children: [
                              (0, D.jsx)(T, { className: `h-3 w-3 shrink-0` }),
                              (0, D.jsxs)(`span`, {
                                className: `truncate`,
                                children: [
                                  e.city ?? `—`,
                      ...
                      (0, D.jsx)(`div`, {
                        ...
                        children: (0, D.jsx)(`div`, {
                          children:
                            q[e.country_code ?? ``] ?? e.country_code ?? `—`,
                        }),
                      }),
                      (0, D.jsx)(`div`, {
                        ...
                        children: [
                          ...
                          e.ai_quality_score != null &&
                            (0, D.jsxs)(`div`, {
                              ...
                              children: [`Q: `, e.ai_quality_score],
                            }),
                        ],
                      }),
                      (0, D.jsx)(`div`, {
                        className: `col-span-2 sm:col-span-1 text-right`,
                        children: (0, D.jsx)(S, { level: e.ai_risk_level }),
                      }),
                      (0, D.jsx)(`div`, {
                        className: `col-span-2 sm:col-span-1 text-center`,
                        children: (0, D.jsx)(`button`, {
                          onClick: (t) => V(e.slug, t),
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [`Showing `, X.length, ` of `, G.length, ` companies`],
          }),
        ],
      }),
      (0, D.jsx)(b, {
                      ...
                      children: [
                        (0, D.jsxs)(`div`, {
                          ...
                          children: [
                            (0, D.jsx)(`div`, {
                              ...
                              children: L.name.slice(0, 2).toUpperCase(),
                            }),
                            (0, D.jsxs)(`div`, {
                              children: [
                                (0, D.jsx)(ee, {
                                ...
                                (0, D.jsxs)(y, {
                                  ...
                                  children: [
                                    L.city ? `${L.city}, ` : ``,
                                    q[L.country_code] ?? L.country_code,
                                  ],
                                }),
                              ],
                            }),
                        ...
                        (0, D.jsxs)(_, {
                          ...
                          children: [
                            ...
                            F.includes(L.slug) ? `Watchlisted` : `Watchlist`,
                          ],
                        }),
                      ],
                    }),
                    (0, D.jsxs)(`div`, {
                      ...
                      children: [
                        (0, D.jsx)(m, {
                          ...
                          children: L.business_type ?? `Supplier`,
                        }),
                        (0, D.jsxs)(m, {
                          variant: `outline`,
                          className: `text-[10px] font-mono`,
                          children: [`Trust: `, L.ai_trust_score, `/100`],
                        }),
                        (0, D.jsx)(S, { level: L.ai_risk_level }),
                      ],
                    }),
                  ],
                }),
                    ...
                    (0, D.jsxs)(`div`, {
                      children: [
                        ...
                        (0, D.jsx)(`span`, {
                          ...
                          children: L.monthly_capacity
                            ? `${L.monthly_capacity.toLocaleString()} m/mo`
                            : `—`,
                        }),
                      ],
                    }),
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    (0, D.jsxs)(`div`, {
                      ...
                      children: [
                        (0, D.jsx)(c, { className: `h-3.5 w-3.5` }),
                        ` AI Sourcing Insight`,
                      ],
                    }),
                    (0, D.jsx)(`p`, {
                      ...
                      children:
                        $.length === 0
                          ? (0, D.jsxs)(`div`, {
                              ...
                              children: [
                                (0, D.jsx)(s, {
                                  className: `h-5 w-5 text-muted-foreground/60 mx-auto mb-1.5`,
                                }),
