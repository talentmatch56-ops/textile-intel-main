import { n as e, t } from "./jsx-runtime-n5LQ9ujS.js";
import { r as n, t as r } from "./utils-DbbrEv-p.js";
...
function c({ className: e, variant: t, ...n }) {
  return (0, o.jsx)(`div`, { className: r(s({ variant: t }), e), ...n });
}
var l = [
    {
      id: `cn1`,
      ...
      sentiment: `positive`,
      importance: `high`,
      published_at: new Date(Date.now() - 36e5 * 2).toISOString(),
    ...
    },
    {
      ...
      sentiment: `negative`,
      importance: `medium`,
      published_at: new Date(Date.now() - 36e5 * 5).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `medium`,
      published_at: new Date(Date.now() - 864e5 * 1).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `high`,
      published_at: new Date(Date.now() - 864e5 * 1.5).toISOString(),
    ...
    },
    {
      ...
      sentiment: `neutral`,
      importance: `low`,
      published_at: new Date(Date.now() - 864e5 * 2).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `high`,
      published_at: new Date(Date.now() - 864e5 * 3).toISOString(),
    ...
    },
    {
      ...
      sentiment: `neutral`,
      importance: `medium`,
      published_at: new Date(Date.now() - 864e5 * 4).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `high`,
      published_at: new Date(Date.now() - 864e5 * 5).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `medium`,
      published_at: new Date(Date.now() - 864e5 * 7).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `medium`,
      published_at: new Date(Date.now() - 864e5 * 9).toISOString(),
    ...
    },
    {
      ...
      sentiment: `positive`,
      importance: `medium`,
      published_at: new Date(Date.now() - 864e5 * 12).toISOString(),
...
export { a as i, u as n, c as r, l as t };
