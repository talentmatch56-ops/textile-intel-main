...
import { t as a } from "./sparkles-D9JfmPPi.js";
import { t as o } from "./stat-card-D9N0zewM.js";
import { n as s, t as c } from "./chevron-up-CFj-K4KU.js";
import { t as l } from "./clipboard-list-CqMyINXY.js";
import { t as u } from "./plus-DnfuNtW7.js";
import { t as d } from "./send-3HqKDgXM.js";
import { t as f } from "./x-COcS-5IT.js";
import { t as p } from "./button-CoQ0AAlw.js";
import { t as m } from "./page-header-KBYaDscd.js";
var h = e(t()),
  g = n(),
  _ = [`GOTS`, `OEKO-TEX`, `ISO 9001`, `SA8000`, `BSCI`, `Fair Trade`, `WRAP`],
  v = {
...
function x() {
  let [e, t] = (0, h.useState)(!1),
    ...
    D = (e) =>
      x((t) => ({
        ...t,
        certs: t.certs.includes(e)
          ? t.certs.filter((t) => t !== e)
          : [...t.certs, e],
      }));
  return (0, g.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      (0, g.jsx)(m, {
        ...
        actions: (0, g.jsxs)(p, {
          ...
          onClick: () => t(!e),
          className: `gap-1.5`,
          children: [(0, g.jsx)(u, { className: `h-3.5 w-3.5` }), ` New RFQ`],
        }),
      }),
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsx)(o, {
            label: `Total RFQs`,
            value: E.length,
            icon: (0, g.jsx)(l, { className: `h-4 w-4` }),
          }),
          (0, g.jsx)(o, {
            label: `Matched`,
            value: E.filter((e) => e.status === `matched`).length,
            delta: { value: `AI-ranked`, positive: !0 },
            icon: (0, g.jsx)(a, { className: `h-4 w-4` }),
          }),
          (0, g.jsx)(o, {
            label: `Active`,
            value: E.filter((e) => e.status === `active`).length,
          }),
          (0, g.jsx)(o, {
            ...
            (0, g.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, g.jsx)(`button`, {
                  ...
                  children: (0, g.jsx)(f, { className: `h-4 w-4` }),
                }),
              ],
            }),
            (0, g.jsxs)(`div`, {
              ...
              children: [
                    ...
                    (0, g.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, g.jsxs)(`select`, {
                          value: n.unit,
                          onChange: (e) =>
                            x((t) => ({ ...t, unit: e.target.value })),
                          className: `w-full h-9 px-2 rounded border border-border bg-card text-sm outline-none focus:border-primary`,
                          children: [
                            (0, g.jsx)(`option`, { children: `kg` }),
                            (0, g.jsx)(`option`, { children: `m²` }),
                            (0, g.jsx)(`option`, { children: `yard` }),
                            (0, g.jsx)(`option`, { children: `piece` }),
                          ],
                        }),
                      ],
                    }),
                ...
                (0, g.jsxs)(`div`, {
                  children: [
                    (0, g.jsxs)(`label`, {
                      className: `block text-xs font-mono uppercase tracking-wider text-muted-foreground mb-1`,
                      children: [`Target Price (USD/`, n.unit, `)`],
                    }),
                    (0, g.jsx)(`input`, {
                      value: n.target_price,
                      onChange: (e) =>
                        x((t) => ({ ...t, target_price: e.target.value })),
                ...
                (0, g.jsxs)(`div`, {
                  children: [
                    ...
                    (0, g.jsx)(`input`, {
                      value: n.lead_time_days,
                      onChange: (e) =>
                        x((t) => ({ ...t, lead_time_days: e.target.value })),
                      className: `w-full h-9 px-3 rounded border border-border bg-card text-sm outline-none focus:border-primary`,
                    }),
                  ],
                }),
                      ...
                      children: _.map((e) =>
                        (0, g.jsx)(
                          `button`,
                          {
                            type: `button`,
                            onClick: () => D(e),
                            className: `px-2.5 py-1 rounded-full text-xs border transition-colors ${n.certs.includes(e) ? `bg-primary/15 text-primary border-primary/40` : `border-border text-muted-foreground hover:border-primary/30`}`,
                            children: e,
                          },
                          e,
                        ),
            ...
            (0, g.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, g.jsxs)(p, {
                  size: `sm`,
                  onClick: async () => {
                    if (!n.product || !n.quantity) return;
                    let {
                      data: { user: e },
                    ...
                    let { error: r } = await i
                      ...
                      .insert({
                        ...
                        target_price: Number(n.target_price),
                        country_code: n.country_code || null,
                        lead_time_days: Number(n.lead_time_days),
                        certifications: n.certs,
                        notes: n.notes,
                        status: `draft`,
                      });
                    if (r) {
                      toast.error(`Failed to submit RFQ: ${r.message}`);
                      return;
                    }
                    (t(!1),
                      x({
                  ...
                  className: `gap-1.5`,
                  children: [
                    (0, g.jsx)(d, { className: `h-3.5 w-3.5` }),
                    ` Submit RFQ`,
                  ],
                }),
              ],
                            ...
                            children: [
                              (0, g.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, g.jsx)(`span`, {
                                    className: `inline-flex items-center rounded border px-1.5 py-0.5 text-[10px] font-mono uppercase tracking-wide ${v[e.status ?? `draft`]}`,
                                    children: e.status,
                                  }),
                                ],
                              }),
