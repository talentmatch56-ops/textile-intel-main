...
var p = (e, t) => {
  ...
  y = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(g) : e.slice(t).join(g),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  re = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
  D = (e) => {
  ...
  M = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(O)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(O) && ((c = s.slice(1)), (l = !0));
    ...
    if (t) {
      let e = t + k,
        n = r;
      r = (t) =>
        t.startsWith(e) ? n(t.slice(e.length)) : j(A, !1, t, void 0, !0);
    }
    if (n) {
      let e = r;
  ...
  de = (e) => e.endsWith(`%`) && G(e.slice(0, -1)),
  q = (e) => H.test(e),
  fe = () => !0,
  pe = (e) => U.test(e) && !ce.test(e),
  me = () => !1,
  he = (e) => le.test(e),
  ge = (e) => ue.test(e),
  _e = (e) => !J(e) && !X(e),
  ...
  Be = se(() => {
    let e = R(`color`),
      ...
      C = () => [X, J, c],
      w = () => [W, `full`, `auto`, ...C()],
      te = () => [K, `none`, `subgrid`, X, J],
      ne = () => [`auto`, { span: [`full`, K, X, J] }, K, X, J],
      T = () => [K, `auto`, X, J],
      E = () => [`auto`, `min`, `max`, `fr`, X, J],
      re = () => [
        `start`,
        `end`,
        `center`,
      ...
      M = () => [e, X, J],
      ie = () => [...y(), De, Ce, { position: [X, J] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, Oe, ye, { size: [X, J] }],
      N = () => [de, Z, Y],
      P = () => [``, `none`, `full`, l, X, J],
      F = () => [``, G, Z, Y],
    ...
    return {
      ...
      classGroups: {
        ...
        "line-clamp": [{ "line-clamp": [G, `none`, X, be] }],
        leading: [{ leading: [a, ...C()] }],
        ...
        shadow: [{ shadow: [``, `none`, u, Ae, Te] }],
        "shadow-color": [{ shadow: M() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Ae, Te] }],
        ...
        "text-shadow": [{ "text-shadow": [`none`, f, Ae, Te] }],
        ...
        "drop-shadow": [{ "drop-shadow": [``, `none`, p, Ae, Te] }],
