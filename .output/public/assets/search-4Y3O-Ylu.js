...
import { t as s } from "./building-2-CXtiLEWT.js";
import { t as c } from "./search-Cr1alROc.js";
import { t as l } from "./shield-check-RJOI63us.js";
import { t as u } from "./x-COcS-5IT.js";
import { t as d } from "./button-CoQ0AAlw.js";
import { t as f } from "./page-header-KBYaDscd.js";
import { t as p } from "./risk-badge-3U59-BfT.js";
var m = e(t()),
  h = n(),
  g = [`GOTS`, `OEKO-TEX`, `ISO 9001`, `SA8000`, `BSCI`, `Fair Trade`],
  _ = [`manufacturer`, `supplier`, `exporter`, `brand`, `trader`];
function v() {
  let [e, t] = (0, m.useState)(``),
    ...
    A = k?.companies ?? [],
    j = k?.countries ?? [],
    M = Object.fromEntries(j.map((e) => [e.code, e.name])),
    N = (0, m.useMemo)(
      () => [...new Set(A.map((e) => e.country_code).filter(Boolean))].sort(),
      [A],
    ),
    P = (0, m.useMemo)(() => {
      if (!D) return [];
        ...
        n &&
          (e = e.filter(
            (e) =>
              ...
              (e.city ?? ``).toLowerCase().includes(n.toLowerCase()) ||
              (e.business_type ?? ``).toLowerCase().includes(n.toLowerCase()) ||
              (e.products ?? []).some((e) =>
                e.toLowerCase().includes(n.toLowerCase()),
              ),
          )),
        C && (e = e.filter((e) => e.country_code === C)),
        x.length > 0 &&
          (e = e.filter((e) =>
            x.some((t) => (e.business_type ?? ``).toLowerCase().includes(t)),
          )),
        y.length > 0 &&
          (e = e.filter((e) =>
            y.every((t) => (e.certifications ?? []).includes(t)),
          )),
        T && (e = e.filter((e) => (e.moq ?? 0) <= Number(T))),
        e.sort((e, t) => (t.ai_trust_score ?? 0) - (e.ai_trust_score ?? 0))
      );
    }, [A, n, C, x, y, T, D]),
    F = () => {
      (v(e), O(!0));
    },
    I = (e) => b((t) => (t.includes(e) ? t.filter((t) => t !== e) : [...t, e])),
    L = (e) => S((t) => (t.includes(e) ? t.filter((t) => t !== e) : [...t, e])),
    R = y.length > 0 || x.length > 0 || C || T;
  return (0, h.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      (0, h.jsx)(f, {
          ...
          (0, h.jsxs)(`div`, {
            ...
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  (0, h.jsx)(o, {
                    className: `absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-primary`,
                  }),
                  (0, h.jsx)(`input`, {
                    value: e,
              ...
              (0, h.jsxs)(d, {
                ...
                className: `shrink-0`,
                children: [
                  (0, h.jsx)(c, { className: `h-4 w-4 mr-2` }),
                  ` Search`,
                ],
              }),
            ],
                ...
                children: [
                  ...
                  _.map((e) =>
                    (0, h.jsx)(
                      ...
                      {
                        onClick: () => L(e),
                        className: `px-2.5 py-1 rounded-full text-xs border transition-colors ${x.includes(e) ? `bg-primary/15 text-primary border-primary/40` : `border-border text-muted-foreground hover:border-primary/40`}`,
                        children: e,
                      },
                      e,
                    ),
                ...
                children: [
                  ...
                  g.map((e) =>
                    (0, h.jsx)(
                      ...
                      {
                        onClick: () => I(e),
                        className: `px-2.5 py-1 rounded-full text-xs border transition-colors ${y.includes(e) ? `bg-primary/15 text-primary border-primary/40` : `border-border text-muted-foreground hover:border-primary/40`}`,
                        children: e,
                      },
                      e,
                    ),
          ...
          children: [
            ...
            P.length === 0
              ? (0, h.jsxs)(`div`, {
                  ...
                  children: [
                    (0, h.jsx)(c, {
                      className: `h-10 w-10 text-muted-foreground mx-auto mb-3 opacity-40`,
                    }),
                    (0, h.jsx)(`div`, {
                              ...
                              (0, h.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, h.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (0, h.jsx)(a, { className: `h-3 w-3` }),
                                      e.city ? `${e.city}, ` : ``,
                                      M[e.country_code ?? ``] ?? e.country_code,
                                    ],
                                  }),
                                ],
                              }),
                              (0, h.jsx)(p, { level: e.ai_risk_level }),
                            ],
                          }),
                          (0, h.jsxs)(`div`, {
