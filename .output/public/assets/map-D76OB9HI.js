...
function m(e, t) {
  return Math.max(32, Math.round((e / t) * 80) + 32);
}
function h(e, t) {
  let n = e / t;
  return n >= 0.7
...
var g = [`Asia`, `Europe`, `Africa`, `Americas`];
function _() {
  let { data: e } = r({
      queryKey: [`map-data`],
      queryFn: async () =>
        (await i.from(`companies`).select(`country_code`)).data ?? [],
    }),
    t = (0, u.useMemo)(() => {
      ...
      return (
        e.forEach((e) => {
          e.country_code && (t[e.country_code] = (t[e.country_code] ?? 0) + 1);
        }),
        Object.keys(t).length > 0 ? t : p
      );
    }, [e]),
    n = Math.max(...Object.values(t)),
    _ = Object.values(t).reduce((e, t) => e + t, 0),
    v = Object.keys(t).length,
    y = [...f]
      .map((e) => ({ ...e, count: t[e.code] ?? 0 }))
      .filter((e) => e.count > 0)
    ...
    b = g
      .map((e) => ({
        region: e,
        countries: f
          .filter((n) => n.region === e && (t[n.code] ?? 0) > 0)
          .map((e) => ({ ...e, count: t[e.code] ?? 0 }))
          .sort((e, t) => t.count - e.count),
      }))
      ...
      (0, d.jsxs)(`div`, {
        ...
        children: [
          (0, d.jsx)(o, {
            ...
            icon: (0, d.jsx)(s, { className: `h-4 w-4` }),
          }),
          (0, d.jsx)(o, {
            label: `Countries`,
            value: v,
            delta: { value: `& growing`, positive: !0 },
            icon: (0, d.jsx)(a, { className: `h-4 w-4` }),
          }),
          (0, d.jsx)(o, {
            label: `Top Market`,
            value: y[0]?.name ?? `China`,
            hint: `${y[0]?.count ?? 142} companies`,
          }),
          (0, d.jsx)(o, {
            label: `Fastest Growing`,
            value: `Bangladesh`,
            delta: { value: `+18% QoQ`, positive: !0 },
            icon: (0, d.jsx)(c, { className: `h-4 w-4` }),
          }),
        ],
      }),
      (0, d.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, d.jsx)(`div`, {
            ...
            children: b.map(({ region: e, countries: t }) =>
              (0, d.jsxs)(
                `div`,
                {
                  children: [
                      ...
                      children: t.map((e) => {
                        ...
                        return (0, d.jsxs)(
                          `div`,
                          {
                            ...
                            children: [
                              (0, d.jsxs)(`div`, {
                                className: `rounded-full flex flex-col items-center justify-center transition-transform group-hover:scale-110 ${h(e.count, n)}`,
                                style: { width: t, height: t },
                                children: [
                                  (0, d.jsx)(`div`, {
                                    className: `font-mono font-bold leading-none`,
                                    style: { fontSize: Math.max(9, t / 5) },
                                    children: e.count,
                                  }),
                                  (0, d.jsx)(`div`, {
                                    className: `font-mono leading-none opacity-70`,
                                    style: { fontSize: Math.max(8, t / 6) },
                                    children: e.code,
                                  }),
                                ],
                              }),
          ...
          (0, d.jsxs)(`div`, {
            ...
            children: [
              (0, d.jsx)(`span`, { children: `Bubble size = company count` }),
                ...
                children: [
                  ...
                  (0, d.jsxs)(
                    `span`,
                    {
                      ...
                      children: [
                        (0, d.jsx)(`span`, {
                          className: `h-2.5 w-2.5 rounded-full ${e.cls}`,
                        }),
                        e.label,
                      ],
                    },
