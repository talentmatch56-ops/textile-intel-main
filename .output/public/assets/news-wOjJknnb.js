...
import { t as s } from "./factory-CJ5GuEGl.js";
import { t as c } from "./file-text-B5lTvAwQ.js";
import { t as l } from "./newspaper-BWNPBK5O.js";
import { t as u } from "./trending-up-B4RhHAzP.js";
import { t as d } from "./page-header-KBYaDscd.js";
var f = a(`external-link`, [
...
function _({ category: e }) {
  ...
  return (0, h.jsxs)(`span`, {
    className: `inline-flex items-center gap-1 rounded border px-1.5 py-0.5 text-[10px] font-mono uppercase tracking-wide ${t.color}`,
    children: [(0, h.jsx)(n, { className: `h-2.5 w-2.5` }), t.label],
  });
}
function v() {
  let [e, t] = (0, m.useState)(`all`),
    [n, a] = (0, m.useState)(``),
    { data: s, isLoading: c } = r({
      queryKey: [`news-all`],
      queryFn: async () => {
        ...
        return { news: e.data ?? [], countries: t.data ?? [] };
      },
    }),
    u = s?.news ?? [],
    p = Object.fromEntries((s?.countries ?? []).map((e) => [e.code, e.name]));
  (0, m.useMemo)(
    () => [`all`, ...new Set(u.map((e) => e.category).filter(Boolean))],
    [u],
  );
  let v = (0, m.useMemo)(
    () => (e === `all` ? u : u.filter((t) => t.category === e)),
    [u, e],
  );
  (v[0], v.slice(1));
  let y = [
      ...
      },
      {
        ...
        category: `market`,
        country_code: `US`,
        published_at: new Date(Date.now() - 4752e5).toISOString(),
      ...
      },
      {
        ...
        category: `trade_policy`,
        country_code: `IN`,
        published_at: new Date(Date.now() - 502e6).toISOString(),
      ...
      },
      {
        ...
        category: `factory_opening`,
        country_code: `PK`,
        published_at: new Date(Date.now() - 5184e5).toISOString(),
        url: `#`,
      },
      {
        id: `10`,
        ...
        category: `price`,
        country_code: `CN`,
        published_at: new Date(Date.now() - 6048e5).toISOString(),
        url: `#`,
      },
      {
        id: `11`,
        ...
        country_code: `DE`,
        published_at: new Date(Date.now() - 648e6).toISOString(),
      ...
      },
      {
        ...
        category: `sustainability`,
        country_code: `ES`,
        published_at: new Date(Date.now() - 6912e5).toISOString(),
        url: `#`,
      },
    ],
    b = e === `all` ? y : y.filter((t) => t.category === e),
    x = u.length > 0 ? v : b,
    S = n
      ? x.filter(
          (e) =>
            e.title.toLowerCase().includes(n.toLowerCase()) ||
            (e.summary ?? ``).toLowerCase().includes(n.toLowerCase()),
        )
      : x,
    C = S[0],
    w = S.slice(1);
      ...
      (0, h.jsxs)(`div`, {
        ...
        children: [
          (0, h.jsx)(o, {
            ...
            icon: (0, h.jsx)(l, { className: `h-4 w-4` }),
          }),
          (0, h.jsx)(o, {
            label: `Trade Policy`,
            value: x.filter((e) => e.category === `trade_policy`).length,
            delta: { value: `this week`, positive: !0 },
          }),
          (0, h.jsx)(o, {
            label: `Sustainability`,
            value: x.filter((e) => e.category === `sustainability`).length,
            delta: { value: `new`, positive: !0 },
          }),
          (0, h.jsx)(o, {
            label: `Factory Openings`,
            value: x.filter((e) => e.category === `factory_opening`).length,
            delta: { value: `new`, positive: !0 },
          }),
        ],
      }),
        ...
        children: [
          ...
          (0, h.jsx)(`div`, {
            ...
            children: [
              ...
              let r = g[n],
                i = n === `all` ? `All News` : (r?.label ?? n);
              return (0, h.jsx)(
                `button`,
                {
                  onClick: () => t(n),
                  className: `px-3 py-1.5 rounded-full text-xs font-mono border transition-colors ${e === n ? `bg-primary text-primary-foreground border-primary` : `border-border text-muted-foreground hover:border-primary/50 hover:text-foreground`}`,
                  children: i,
                },
                n,
              );
            ...
            children: [
              (0, h.jsxs)(`div`, {
                ...
                children: [
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      (0, h.jsx)(_, { category: C.category }),
                      (0, h.jsx)(`span`, {
                        className: `text-[10px] font-mono text-muted-foreground`,
                        children: C.published_at
                      ...
                      C.country_code &&
                        (0, h.jsx)(`span`, {
                          className: `text-[10px] font-mono text-muted-foreground`,
                          children: p[C.country_code] ?? C.country_code,
                        }),
                    ],
                  }),
                  (0, h.jsx)(`h2`, {
              ...
              C.url &&
                ...
                (0, h.jsx)(`a`, {
                  ...
                  children: (0, h.jsx)(f, { className: `h-4 w-4` }),
                }),
            ],
          }),
        }),
                  ...
                  (0, h.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      e.country_code &&
                        (0, h.jsx)(`span`, {
                          className: `text-[10px] font-mono text-muted-foreground`,
                          children: p[e.country_code] ?? e.country_code,
                        }),
                    ],
                  }),
                ],
