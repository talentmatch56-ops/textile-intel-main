...
import { t as ee } from "./circle-alert-D6OZZXPz.js";
import { t as te } from "./earth-DnUaiYk8.js";
import { t as ne } from "./loader-circle-Bl7wwTNN.js";
import { t as s } from "./sparkles-D9JfmPPi.js";
import { t as c } from "./stat-card-D9N0zewM.js";
import { t as re } from "./building-2-CXtiLEWT.js";
import { t as ie } from "./download-B4t8_M7W.js";
import { t as ae } from "./factory-CJ5GuEGl.js";
import { t as l } from "./refresh-cw-DJUgOTNr.js";
import {
  i as u,
  n as oe,
  r as d,
  t as f,
} from "./mock-company-news-DAcH1U7z.js";
import { t as se } from "./x-COcS-5IT.js";
import { t as p } from "./button-CoQ0AAlw.js";
import {
  a as ce,
  i as le,
  n as ue,
  r as de,
  t as fe,
} from "./sheet-RFeW-6F5.js";
import { t as pe } from "./page-header-KBYaDscd.js";
import { t as m } from "./risk-badge-3U59-BfT.js";
import { t as h } from "./dist-ByBcCr1c.js";
import {
  O as g,
  P as _,
  a as v,
...
import { n as x, t as he } from "./AreaChart-B3i_z7zm.js";
import { t as S } from "./BarChart-DuAVZb5T.js";
import { t as C } from "./mock-companies-DOsMh2YD.js";
var ge = a(`layers`, [
    [
      `path`,
      {
  ...
  _e = [
    ...
    },
    {
      ...
      published_at: new Date(Date.now() - 2592e5).toISOString(),
    },
    {
      id: `d5`,
      ...
      category: `trade_policy`,
      published_at: new Date(Date.now() - 3456e5).toISOString(),
    },
    {
      id: `d6`,
      ...
      source: `Textilforum`,
      category: `market`,
      published_at: new Date(Date.now() - 432e6).toISOString(),
    },
  ],
  E = {
...
function ve() {
  let [e, t] = (0, w.useState)(!1),
    [n, a] = (0, w.useState)(!1),
    [ve, ye] = (0, w.useState)(!1),
    [O, be] = (0, w.useState)(E.title),
    [k, A] = (0, w.useState)(E.date),
    [j, M] = (0, w.useState)(!1),
    [N, P] = (0, w.useState)(`Never`),
    [F, I] = (0, w.useState)([]),
    [xe, L] = (0, w.useState)(0),
    [R, z] = (0, w.useState)(null),
    [Se, B] = (0, w.useState)(!1);
  ((0, w.useMemo)(() => {
    if (typeof window < `u`) {
      let e = new Date();
      ((E.title = `GMIntel AI Briefing — ${e.toLocaleDateString(`en-US`, { month: `long`, year: `numeric` })}`),
        (E.date = e.toLocaleDateString(`en-US`, {
          month: `long`,
          day: `numeric`,
          year: `numeric`,
        })));
    ...
    (0, w.useState)(() => {
      if (typeof window < `u`) {
        let e = new Date();
        (be(
          `GMIntel AI Briefing — ${e.toLocaleDateString(`en-US`, { month: `long`, year: `numeric` })}`,
        ),
          A(
    ...
    (0, w.useEffect)(() => {
      if (typeof window < `u`) {
        ye(!0);
        let e = localStorage.getItem(`gmintel_watchlist`);
        e && I(JSON.parse(e));
        let t = localStorage.getItem(`gmintel_synced_news`);
        L(t ? JSON.parse(t).length : 0);
        let n = localStorage.getItem(`gmintel_last_sync_time`);
        n && P(n);
      }
    }, []));
  let V = (e = !1) => {
    j ||
      (M(!0),
      e || h.info(`Syncing Textile Intelligence databases...`),
      setTimeout(() => {
        let t = localStorage.getItem(`gmintel_synced_news`),
          n = t ? JSON.parse(t) : [],
          r = [];
        oe.forEach((e) => {
          n.some((t) => t.id === e.id) || r.push(e);
        });
        let i = [...r, ...n];
        (localStorage.setItem(`gmintel_synced_news`, JSON.stringify(i)),
          L(i.length));
        ...
        if (
          (P(a),
          localStorage.setItem(`gmintel_last_sync_time`, a),
          r.length > 0)
        ) {
          let e = localStorage.getItem(`gmintel_watchlist`),
            t = e ? JSON.parse(e) : [],
            n = localStorage.getItem(`gmintel_notifications`),
            i = n ? JSON.parse(n) : [],
            a = [];
          if (
            (r.forEach((e) => {
              t.includes(e.company_slug) &&
                a.push({
            ...
            let e = [...a, ...i];
            (localStorage.setItem(`gmintel_notifications`, JSON.stringify(e)),
              window.dispatchEvent(new Event(`gmintel_new_notification`)),
              h.success(
                `Found ${a.length} updates for companies on your watchlist!`,
              ));
          }
        }
        (M(!1), e || h.success(`Sync completed. Added ${r.length} updates.`));
      }, 1500));
  };
  (0, w.useEffect)(() => {
    let e = setInterval(() => {
  ...
  let Ce = () => {
      (a(!0),
        ...
        setTimeout(() => {
          (a(!1),
            t(!0),
            h.success(`Executive briefing generated successfully!`));
        }, 1500));
    },
    { data: H } = r({
      queryKey: [`dashboard`],
    ...
    U = (0, w.useMemo)(
      () =>
        H
          ? Array.isArray(H.companies)
            ? H.companies
            : H.companies && Array.isArray(H.companies.data)
              ? H.companies.data
              : []
          : [],
      [H],
    ...
    Te = H?.prices ?? [],
    Ee = (0, w.useMemo)(
      () => Object.fromEntries(G.map((e) => [e.code, e.name])),
      [G],
    ),
    q = W.filter((e) =>
      (e.business_type ?? ``).toLowerCase().includes(`manufactur`),
    ).length,
    De = W.filter((e) =>
      (e.business_type ?? ``).toLowerCase().includes(`supplier`),
    ).length,
    Oe = W.filter((e) =>
      (e.business_type ?? ``).toLowerCase().includes(`brand`),
    ).length,
    J = new Date();
  (J.setHours(0, 0, 0, 0),
    W.filter((e) => e.created_at && new Date(e.created_at) >= J).length);
  let Y = {};
  W.forEach((e) => {
    e.country_code && (Y[e.country_code] = (Y[e.country_code] ?? 0) + 1);
  });
  let ke = Object.entries(Y)
      .map(([e, t]) => ({
        code: e,
        name: G.find((t) => t.code === e)?.name ?? e,
        count: t,
      }))
      .sort((e, t) => t.count - e.count)
      .slice(0, 8),
    Ae = Array.from({ length: 12 }).map((e, t) => {
      let n = 100 + Math.sin(t / 2) * 6 + t * 1.2;
      return {
        month: [
          `Jan`,
          `Feb`,
        ...
        cotton: Math.round(n),
        polyester: Math.round(n * 0.72),
        denim: Math.round(n * 1.15),
      };
    }),
    X = (0, w.useMemo)(() => W.filter((e) => F.includes(e.slug)), [W, F]),
    Z = (0, w.useMemo)(() => {
      let e =
        typeof window < `u`
          ? localStorage.getItem(`gmintel_synced_news`)
          : null;
      return [...(e ? JSON.parse(e) : []), ...f].sort(
        (e, t) =>
          new Date(t.published_at).getTime() -
          new Date(e.published_at).getTime(),
      );
    }, [xe]),
    Q = (0, w.useMemo)(
      () => (R ? Z.filter((e) => e.company_slug === R.slug) : []),
      [R, Z],
    ),
    je = (0, w.useMemo)(() => {
      if (!R) return ``;
      if (Q.length === 0)
        return `${R.name} maintains a steady operations status with zero recent announcements. Sourcing metrics are verified.`;
      let e = Q.filter((e) => e.sentiment === `positive`).length,
        t = Q.filter((e) => e.sentiment === `negative`).length,
        n = Q[0],
        r = `AI analysis highlights a predominantly ${e >= t ? `positive` : `cautious`} outlook. `;
      return (
        (r += `Main development: "${n.title}". `),
        t > 0
          ? (r += `Supply risks are present but offset by stable raw material reserves.`)
          : (r += `Driven by strong sustainability progress and capacity increases.`),
        r
      );
    }, [R, Q]),
    $ = (e, t) => {
      t.stopPropagation();
      let n = F.includes(e) ? F.filter((t) => t !== e) : [...F, e];
      (I(n),
        localStorage.setItem(`gmintel_watchlist`, JSON.stringify(n)),
        h.success(
          F.includes(e) ? `Removed from watchlist` : `Added to watchlist`,
        ));
    };
  return (0, T.jsxs)(`div`, {
    className: `space-y-8`,
    children: [
        ...
        actions: (0, T.jsxs)(`div`, {
          ...
          children: [
            (0, T.jsxs)(p, {
              ...
              children: [
                (0, T.jsx)(l, {
                  className: o(`h-3.5 w-3.5`, j && `animate-spin`),
                }),
                `Sync DB`,
              ],
            }),
            (0, T.jsx)(p, {
              ...
              children: n
                ...
                : (0, T.jsxs)(T.Fragment, {
                    children: [
                      (0, T.jsx)(s, { className: `h-3.5 w-3.5 mr-1.5` }),
      ...
      (0, T.jsxs)(`div`, {
        ...
        children: [
          (0, T.jsx)(c, {
            label: `Companies`,
            value: we.toLocaleString(),
            delta: { value: `+12.4%`, positive: !0 },
            icon: (0, T.jsx)(re, { className: `h-4 w-4` }),
          }),
          (0, T.jsx)(c, {
            label: `Manufacturers`,
            value: q,
            delta: { value: `+8.1%`, positive: !0 },
            icon: (0, T.jsx)(ae, { className: `h-4 w-4` }),
          }),
          (0, T.jsx)(c, {
            label: `Suppliers`,
            value: De,
            delta: { value: `+3.2%`, positive: !0 },
            icon: (0, T.jsx)(ge, { className: `h-4 w-4` }),
          }),
          (0, T.jsx)(c, {
            label: `Brands`,
            value: Oe,
            delta: { value: `+1.9%`, positive: !0 },
            icon: (0, T.jsx)(s, { className: `h-4 w-4` }),
          }),
          (0, T.jsx)(c, {
            label: `Countries`,
            value: Object.keys(Y).length,
            hint: `${G.length} tracked`,
            icon: (0, T.jsx)(te, { className: `h-4 w-4` }),
          }),
          (0, T.jsx)(c, {
            label: `Sync Engine`,
            value: N === `Never` ? `Ready` : N,
            delta: { value: j ? `polling` : `sync active`, positive: !0 },
            icon: (0, T.jsx)(l, { className: `h-4 w-4` }),
          }),
        ],
      }),
      (0, T.jsxs)(`div`, {
                ...
                children:
                  X.length === 0
                    ? (0, T.jsxs)(`div`, {
                        ...
                        children: [
                          (0, T.jsx)(u, {
                            className: `h-8 w-8 text-muted-foreground/45 mx-auto mb-2`,
                          }),
                          (0, T.jsx)(`p`, {
                    ...
                    : X.map((e) => {
                        let t = Z.find((t) => t.company_slug === e.slug);
                        return (0, T.jsxs)(
                          `div`,
                          {
                            onClick: () => {
                                  ...
                                  (0, T.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, T.jsxs)(d, {
                                        ...
                                        children: [`Trust `, e.ai_trust_score],
                                      }),
                                      (0, T.jsx)(m, { level: e.ai_risk_level }),
                                    ],
                                  }),
                                  t
                                    ? (0, T.jsxs)(`div`, {
          ...
          (0, T.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, T.jsx)(`div`, {
                ...
                children: Z.slice(0, 6).map((e) =>
                  (0, T.jsxs)(
                    `div`,
                    {
                      onClick: () => {
                        let t = W.find((t) => t.slug === e.company_slug);
                        t && (z(t), B(!0));
                      },
        ...
        children: [
          ...
          (0, T.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, T.jsx)(`div`, {
                className: `divide-y divide-border`,
                children: (K.length > 0 ? K : _e).map((e) =>
                  (0, T.jsxs)(
                    `div`,
                    {
          ...
          children: (0, T.jsxs)(`div`, {
            ...
            children: [
              (0, T.jsx)(`button`, {
                ...
                children: (0, T.jsx)(se, { className: `h-4 w-4` }),
              }),
              (0, T.jsxs)(`div`, {
              ...
              (0, T.jsxs)(`div`, {
                ...
                children: [`Compiled on `, k, ` · Live Market Intelligence`],
              }),
              (0, T.jsx)(`div`, {
...
`),
                      ...
                      ((r.href = n),
                        (r.download = `gmintel_ai_briefing_${new Date().toISOString().slice(0, 10)}.txt`),
                        document.body.appendChild(r),
                        r.click(),
                        document.body.removeChild(r),
                        URL.revokeObjectURL(n),
                        h.success(`Downloading briefing...`));
                    },
                    className: `gap-1.5`,
                    children: [
                      (0, T.jsx)(ie, { className: `h-3.5 w-3.5` }),
                      ` Download`,
                    ],
                  }),
                  (0, T.jsx)(p, {
                      ...
                      children: [
                            ...
                            (0, T.jsxs)(`div`, {
                              children: [
                                ...
                                (0, T.jsxs)(de, {
                                  ...
                                  children: [
                                    R.city ? `${R.city}, ` : ``,
                                    Ee[R.country_code] ?? R.country_code,
                                  ],
                                }),
                              ],
                            }),
                        ...
                        (0, T.jsxs)(p, {
                          ...
                          children: [
                            ...
                            F.includes(R.slug) ? `Watchlisted` : `Watchlist`,
                          ],
                        }),
                      ],
                    }),
                    (0, T.jsxs)(`div`, {
                      ...
                      children: [
                        (0, T.jsx)(d, {
                          ...
                          children: R.business_type ?? `Supplier`,
                        }),
                        (0, T.jsxs)(d, {
                          variant: `outline`,
                          className: `text-[10px] font-mono`,
                          children: [`Trust: `, R.ai_trust_score, `/100`],
                        }),
                        (0, T.jsx)(m, { level: R.ai_risk_level }),
                      ],
                    }),
                  ],
                }),
                    ...
                    (0, T.jsxs)(`div`, {
                      children: [
                        ...
                        (0, T.jsx)(`span`, {
                          ...
                          children: R.monthly_capacity
                            ? `${R.monthly_capacity.toLocaleString()} m/mo`
                            : `—`,
                        }),
                      ],
                    }),
                  ...
                  children: [
                    (0, T.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, T.jsxs)(`span`, {
                          className: `text-[10px] font-mono text-muted-foreground`,
                          children: [Q.length, ` announcements`],
                        }),
                      ],
                    }),
                    (0, T.jsx)(`div`, {
                      ...
                      children:
                        Q.length === 0
                          ? (0, T.jsxs)(`div`, {
                              ...
                              children: [
                                (0, T.jsx)(ee, {
                                  className: `h-5 w-5 text-muted-foreground/65 mx-auto mb-1.5`,
                                }),
