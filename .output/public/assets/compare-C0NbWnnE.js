...
import { t as a } from "./git-compare-BHx0fE6E.js";
import { t as o } from "./plus-DnfuNtW7.js";
import { t as s } from "./x-COcS-5IT.js";
import { t as c } from "./page-header-KBYaDscd.js";
import { t as l } from "./risk-badge-3U59-BfT.js";
var u = e(t()),
  d = n(),
  f = [
...
function p({ value: e, max: t = 100 }) {
  if (e == null)
    return (0, d.jsx)(`span`, {
      className: `text-muted-foreground text-sm`,
      children: `—`,
    });
  let n = Math.min(100, (e / t) * 100);
  return (0, d.jsxs)(`div`, {
    ...
    children: [
      (0, d.jsx)(`div`, {
        ...
        children: (0, d.jsx)(`div`, {
          className: `h-full rounded-full ${n >= 70 ? `bg-success` : n >= 40 ? `bg-warning` : `bg-destructive`}`,
          style: { width: `${n}%` },
        }),
      }),
      (0, d.jsx)(`span`, {
    ...
    : e === `ai_risk_level`
      ...
      : [
        ...
        : Array.isArray(t)
          ...
          : e === `moq` || e === `monthly_capacity`
            ? (0, d.jsxs)(`span`, {
                className: `text-sm font-mono tabular-nums`,
                children: [t.toLocaleString(), ` units`],
              })
            : e === `lead_time_days`
              ? (0, d.jsxs)(`span`, {
...
function h() {
  let [e, t] = (0, u.useState)([]),
    ...
    _ = g ?? [],
    v = (0, u.useMemo)(
      () => e.map((e) => _.find((t) => t.id === e)).filter(Boolean),
      [e, _],
    ),
    y = (0, u.useMemo)(
      () =>
        _.filter(
          (t) =>
            !e.includes(t.id) && t.name.toLowerCase().includes(n.toLowerCase()),
        ).slice(0, 8),
      [_, e, n],
    ),
    b = (n) => {
      e.length < 3 && (t((e) => [...e, n]), h(!1), l(``));
    },
    x = (e) => t((t) => t.filter((t) => t !== e));
  return (0, d.jsxs)(`div`, {
    className: `space-y-6`,
    children: [
      (0, d.jsx)(c, {
                    ...
                    (0, d.jsxs)(`div`, {
                      children: [
                        ...
                        (0, d.jsxs)(`div`, {
                          ...
                          children: [e.country_code, ` · `, e.business_type],
                        }),
                      ],
                    }),
                    (0, d.jsx)(`button`, {
                      ...
                      children: (0, d.jsx)(s, { className: `h-4 w-4` }),
                    }),
                  ],
                },
                e.id,
        ...
        (0, d.jsxs)(`div`, {
          ...
          children: [
            (0, d.jsxs)(`div`, {
              ...
              style: { gridTemplateColumns: `200px repeat(${v.length}, 1fr)` },
              children: [
                (0, d.jsx)(`div`, {
            ...
            f.map((e, t) =>
              (0, d.jsxs)(
                `div`,
                {
                  className: `grid border-b border-border last:border-0 ${t % 2 == 0 ? `` : `bg-muted/20`}`,
                  style: {
                    gridTemplateColumns: `200px repeat(${v.length}, 1fr)`,
                  },
                  children: [
                    (0, d.jsx)(`div`, {
