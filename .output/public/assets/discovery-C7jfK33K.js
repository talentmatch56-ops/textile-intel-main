...
import { t as s } from "./stat-card-D9N0zewM.js";
import { t as c } from "./clock-DlSgh5Ru.js";
import { t as l } from "./radar-BYXsYask.js";
import { t as u } from "./refresh-cw-DJUgOTNr.js";
...
import { t as y } from "./BarChart-DuAVZb5T.js";
var b = e(t()),
  x = n(),
  S = [
    {
      ...
      ai_trust_score: 82,
      ai_risk_level: `low`,
      discovered_at: new Date(Date.now() - 36e5 * 2),
    ...
    },
    {
      ...
      discovered_at: new Date(Date.now() - 36e5 * 5),
      source: `Web Crawl`,
    },
    {
      id: `d3`,
      ...
      ai_trust_score: 68,
      ai_risk_level: `medium`,
      discovered_at: new Date(Date.now() - 864e5),
    ...
    },
    {
      ...
      ai_trust_score: 91,
      ai_risk_level: `low`,
      discovered_at: new Date(Date.now() - 864e5 * 2),
    ...
    },
    {
      ...
      ai_trust_score: 61,
      ai_risk_level: `high`,
      discovered_at: new Date(Date.now() - 864e5 * 3),
    ...
    },
    {
      ...
      ai_trust_score: 72,
      ai_risk_level: `low`,
      discovered_at: new Date(Date.now() - 864e5 * 4),
      source: `B2B Portal`,
    },
    {
      id: `d8`,
      ...
      ai_trust_score: 79,
      ai_risk_level: `medium`,
      discovered_at: new Date(Date.now() - 864e5 * 5),
...
function w({ status: e }) {
  let t = {
    ...
    n = t[e] ?? t.pending_review,
    r = n.icon;
  return (0, x.jsxs)(`span`, {
    className: `inline-flex items-center gap-1 rounded border px-1.5 py-0.5 text-[10px] font-mono uppercase tracking-wide ${n.cls}`,
    children: [(0, x.jsx)(r, { className: `h-2.5 w-2.5` }), n.label],
  });
}
function T() {
  let [e, t] = (0, b.useState)(`all`),
    { data: n } = r({
      queryKey: [`discovery`],
      queryFn: async () =>
        (
          await i
            .from(`companies`)
            .select(
              `id,name,country_code,city,business_type,status,ai_trust_score,ai_risk_level,created_at`,
            )
    ...
    T =
      a.length > 0
        ? a.map((e) => ({
            ...e,
            discovered_at: new Date(e.created_at),
            source: `Database`,
          }))
        : S,
    E = (0, b.useMemo)(
      () => (e === `all` ? T : T.filter((t) => t.status === e)),
      [T, e],
    ),
    D = (0, b.useMemo)(
      () => ({
        total: T.length,
        pending: T.filter((e) => e.status === `pending_review`).length,
        verified: T.filter((e) => e.status === `verified`).length,
        rate: Math.round(
          (T.filter((e) => e.status === `verified`).length /
            Math.max(T.length, 1)) *
            100,
        ),
      }),
    ...
    children: [
      (0, x.jsx)(f, {
        ...
        actions: (0, x.jsxs)(d, {
          ...
          className: `gap-1.5`,
          children: [
            (0, x.jsx)(u, { className: `h-3.5 w-3.5` }),
            ` Run discovery`,
          ],
        }),
      }),
      (0, x.jsxs)(`div`, {
        ...
        children: [
          (0, x.jsx)(s, {
            label: `Discovered`,
            value: D.total,
            icon: (0, x.jsx)(l, { className: `h-4 w-4` }),
          ...
          (0, x.jsx)(s, {
            label: `Verified`,
            value: D.verified,
            icon: (0, x.jsx)(o, { className: `h-4 w-4` }),
            delta: { value: `+12 today`, positive: !0 },
          }),
          (0, x.jsx)(s, {
            label: `Verify Rate`,
            value: `${D.rate}%`,
          ...
          (0, x.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, x.jsx)(`div`, {
                ...
                children: [`all`, `pending_review`, `verified`].map((n) =>
                  (0, x.jsx)(
                    `button`,
                    {
                      onClick: () => t(n),
                      className: `px-2.5 py-1 rounded text-xs font-mono border transition-colors ${e === n ? `bg-primary/15 text-primary border-primary/40` : `border-border text-muted-foreground hover:border-primary/30`}`,
                      children:
                        n === `all`
                          ? `All`
                          : n === `pending_review`
