    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      <div className="hidden lg:flex flex-col justify-between p-10 bg-sidebar border-r border-sidebar-border relative overflow-hidden">
        ...
        <Link to="/" className="relative flex items-center gap-2">
          <div className="h-8 w-8 rounded-md bg-primary flex items-center justify-center font-mono text-primary-foreground font-bold">
            GM
          </div>
        ...
        <div className="relative space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            30,000+ verified companies, AI risk & quality scores, live prices,
            and a natural-language sourcing assistant — all in one terminal.
          </p>
        </div>
        <div className="relative text-[10px] font-mono text-muted-foreground">
          SECURE · SOC-2 READY · RBAC
        </div>
      </div>
