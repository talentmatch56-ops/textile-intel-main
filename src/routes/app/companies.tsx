...
import { Search, Filter, Building2, MapPin, Users, ArrowUpDown, Star, Sparkles, Clock, AlertCircle, FileText } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card overflow-hidden">
        <div className="grid grid-cols-12 gap-2 px-4 py-2.5 text-[10px] font-mono uppercase tracking-widest text-muted-foreground bg-muted/30 border-b border-border">
          <button className="col-span-5 sm:col-span-4 flex items-center gap-1 hover:text-foreground text-left" onClick={() => handleSort("name")}>
            ...
            return (
              ...
              >
                <div className="col-span-5 sm:col-span-4 min-w-0">
                  <div className="font-medium text-foreground hover:text-primary transition-colors truncate">{c.name}</div>
                ...
                <div className="col-span-2 sm:col-span-1 text-right"><RiskBadge level={c.ai_risk_level} /></div>
                <div className="col-span-2 sm:col-span-1 text-center">
                  ...
                  >
                    <Star className={cn("h-4 w-4 transition-transform hover:scale-110", isFollowed ? "fill-primary text-primary" : "text-muted-foreground")} />
                  </button>
                </div>
              </div>
            );
          ...
          {selectedCompany && (
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-primary/30 bg-gradient-to-br from-primary/[0.06] to-transparent p-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed font-sans">{aiSummary}</p>
              </div>
