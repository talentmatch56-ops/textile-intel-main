...
const MOCK_PIPELINE = [
  ...
  },
  {
    ...
    ai_trust_score: 68,
    ai_risk_level: "medium",
    discovered_at: new Date(Date.now() - 86400000),
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <StatCard
          ...
          delta={{ value: "+54 today", positive: true }}
        />
        <StatCard
        ...
        <StatCard
          ...
          delta={{ value: "+12 today", positive: true }}
        />
        <StatCard
          label="Verify Rate"
          value={`${stats.rate}%`}
          ...
          {filtered.map((c) => (
            ...
            >
              ...
              <div className="col-span-1 text-right">
                <StatusBadge status={c.status ?? "pending_review"} />
              </div>
            </div>
          ))}
        </div>
