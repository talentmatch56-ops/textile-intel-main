...
function Page() {
  ...
  const filteredTable = useMemo(() => {
    ...
    if (searchFilter)
      list = list.filter(
        (p) =>
          p.product.toLowerCase().includes(searchFilter.toLowerCase()) ||
  ...
  const COUNTRY_PRICES: Record<string, { country: string; price: number }[]> = {
    ...
    Silk: [
      ...
      { country: "China", price: 16.0 },
      { country: "Vietnam", price: 14.5 },
      { country: "Italy", price: 28.0 },
      { country: "Thailand", price: 18.0 },
      { country: "Brazil", price: 22.0 },
    ],
    Wool: [
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatCard
          ...
          value="218"
          delta={{ value: "refreshed daily", positive: true }}
        />
        <StatCard
          label="Cotton US"
          value="$0.74/lb"
      ...
      <div className="rounded-lg border border-border bg-card overflow-hidden">
        ...
        <div className="divide-y divide-border">
          ...
          {filteredTable.map((p, i) => (
            ...
            >
              ...
              <div className="hidden sm:block col-span-2 text-muted-foreground truncate">
                {p.country}
              </div>
              <div className="hidden md:block col-span-1 font-mono text-xs text-muted-foreground">
                {p.unit}
              </div>
              <div className="col-span-3 sm:col-span-2 text-right font-mono tabular-nums">
                ${p.low.toFixed(2)}
              </div>
              <div className="col-span-3 sm:col-span-2 text-right font-mono tabular-nums">
                ${p.high.toFixed(2)}
        ...
        <div className="px-4 py-2 border-t border-border bg-muted/20 text-[10px] font-mono text-muted-foreground flex items-center justify-between">
          <span>
            ...
            {filteredTable.length} records shown
          </span>
