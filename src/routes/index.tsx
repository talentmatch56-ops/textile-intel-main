    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center gap-6">
          <Link to="/" className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-md bg-primary flex items-center justify-center font-mono text-primary-foreground text-sm font-bold">
              GM
            </div>
            <div className="font-display font-bold">
              GMIntel<span className="text-primary">.AI</span>
            </div>
          </Link>
          ...
          <Button size="sm" asChild>
            <Link to="/app">
              Launch Terminal <ArrowRight className="ml-1 h-3.5 w-3.5" />
            </Link>
          </Button>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="mt-6 font-display text-5xl md:text-6xl font-bold tracking-tight leading-tight">
                The <span className="text-primary">Bloomberg</span> terminal for
                the global textile industry.
              </h1>
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                GMIntel AI discovers, verifies, and analyzes manufacturers,
                suppliers, brands, prices, and market signals across 40+ textile
                hubs — surfaced through a real-time terminal and an AI sourcing
                copilot.
              </p>
              ...
              <div className="rounded-xl border border-border bg-card overflow-hidden shadow-2xl glow-primary">
                ...
                <div className="p-5 font-mono text-xs space-y-3">
                  <div className="text-muted-foreground">
                    <span className="text-primary">❯</span> search suppliers
                    cotton india certified
                  </div>
      ...
      <section id="modules" className="border-t border-border bg-card/30">
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <h2 className="mt-2 font-display text-3xl md:text-4xl font-bold max-w-2xl">
            Twelve modules. One intelligence layer.
          </h2>
          <p className="mt-3 text-muted-foreground max-w-2xl">
            Every tool in GMIntel connects to the same live data engine — no
            silos, no switching tabs.
          </p>
      ...
      <section id="intelligence" className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <h2 className="mt-2 font-display text-3xl md:text-4xl font-bold max-w-2xl">
            Built on live data. Powered by AI.
          </h2>
          <p className="mt-3 text-muted-foreground max-w-2xl">
            Every signal on GMIntel is sourced from public trade data, verified
            registries, and licensed market feeds — then enriched by AI.
          </p>
          ...
          <div className="mt-8 p-4 rounded-lg border border-border bg-muted/20 flex items-start gap-3">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              All AI-generated insights are clearly labeled. We use public trade
              registries, B2B directories, and licensed price feeds. AI
              estimates are never presented as financial advice.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="coverage" className="border-t border-border bg-card/30">
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <h2 className="mt-2 font-display text-3xl md:text-4xl font-bold max-w-2xl">
            40+ countries. Every major textile hub.
          </h2>
          <p className="mt-3 text-muted-foreground max-w-2xl">
            From Dhaka to Guangdong, Izmir to Ludhiana — GMIntel covers the
            world's entire textile supply chain geography.
          </p>
          <div className="mt-10 space-y-3">
            {COVERAGE_HUBS.map((h) => (
              ...
              >
                ...
                <div className="shrink-0 text-sm font-mono font-semibold text-primary">
                  {h.pct}%
                </div>
              </div>
            ))}
      ...
      <footer className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <div className="flex flex-wrap items-start justify-between gap-8 mb-8">
            <div>
              ...
              <p className="text-xs text-muted-foreground max-w-xs">
                The intelligence terminal for global textile sourcing. Built for
                procurement teams, brands and investors.
              </p>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-border text-xs text-muted-foreground font-mono">
            <div>
              © {new Date().getFullYear()} GMIntel AI · Global Textile
              Intelligence
            </div>
            <div>
