...
export const MOCK_COMPANIES: Company[] = [
  ...
  },
  {
    id: "mc14",
    slug: "welspun-india",
    name: "Welspun India Home Textiles",
    country_code: "IN",
    city: "Anjar",
    business_type: "exporter",
    ai_trust_score: 87,
